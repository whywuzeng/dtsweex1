...
public class CameraModule {
    ...
    public void captureImage(Activity activity, final ModuleResultListener listener){
        ...
        String fileName = java.util.UUID.randomUUID().toString() +  ".jpg";//"nat_img_" + new Date().getTime() + ".jpg";
    ...
    public void captureVideo(Activity activity, final ModuleResultListener listener) {
        ...
        mIsTakingVideo = true;
        String fileName = java.util.UUID.randomUUID().toString() + ".mov";//"nat_video_" + new Date().getTime() + ".mov";
        Intent intent = new Intent();
