...
public abstract class AbsWeexActivity extends AppCompatActivity implements IWXRenderListener {
  ...
  protected void renderPageByURL(String url, String jsonInitData) {
    ...
    if(isTestUrl.equals("N")){
      ...
      mInstance.render(getPageName(), loadAssetttt(url,this), options, jsonInitData, CommonUtils.getDisplayWidth(this), CommonUtils.getDisplayHeight(this), WXRenderStrategy.APPEND_ASYNC);
