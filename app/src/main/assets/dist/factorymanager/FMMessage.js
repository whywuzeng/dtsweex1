...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMMessage.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-06ff6194"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  created: function created() {
    ...
    storage.getItem("messageID", function (event) {
      ...
      stream.fetch({
        method: "POST",
        url: app_server_url + "APPDriverList/GetDriverInfomation?DriverID=" + JSON.parse(event.data).DriverID + "&ID=" + JSON.parse(event.data).ID,
        // url: `${app_server_url}APPDriverList/Driver_Security_Select?DriverID=${this.driverID}&shipid=${this.FactoryID}`,
        type: "json"
      }, function (ret) {
        //  modal.toast({ message: "bjorder2"});
        ...
        if (ret.ok === false) {
          ...
          _this2.list = ret.data.Data.BillStatusReturn;
        }
      });
    });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: ["list-top-left", "iconfont"],
      class: [item == 1 ? 'red' : '']
    }, [_vm._v(" " + _vm._s(item.Info_type) + " - " + _vm._s(item.Factory))]), _c('text', {
      staticClass: ["list-top-right", "font26"]
    }, [_vm._v(_vm._s(item.InfoTime))])]), _c('text', {
      staticClass: ["list-bottom", "font26"]
    }, [_vm._v(_vm._s(item.Info_msg))])])
  }))])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
