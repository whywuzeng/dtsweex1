...
var app_images_url = '';
storage.getItem('app_images_url', function (event) {
  if (event.data != null && event.data != undefined && event.data != "undefined") {
    app_images_url = event.data;
  }
});

exports.default = {
  name: 'TMMy',
  components: { WxcMinibar: _weexUi.WxcMinibar, WxcCell: _weexUi.WxcCell, WxcButton: _weexUi.WxcButton, WxcDialog: _weexUi.WxcDialog },
  data: function data() {
    return {
      url: '',
      photoPath: "",
  ...
  methods: {
    //更换头像
    photoBtnClick: function photoBtnClick() {
      var _this = this;

      (0, _DTSPlugins.CaptureImage)({}, function (err, ret) {
        if (err === null || err === undefined) {

          // modal.toast({ message: "photoPath========" + ret.path });
          _this.photoPath = ret.path;

          //--save the photo path.
          var tkey = _this.userId + _app_constants.app_user_photo_path_key;
          // modal.toast({ message: "save photo tkey =" + tkey });
          storage.setItem(tkey, ret.path, function (event) {});
        }
      });
    },
    messageCellClicked: function messageCellClicked() {
      storage.getItem(_app_constants.app_bundle_url, function (event) {
        if (event.data === undefined || event.data === null) {
          return;
        }
        navigator.push({
          url: event.data + "factorymanager/FMMessage.js",
          animated: "true"
        }, function (event) {});
      });
    },
    ...
    aboutCellClicked: function aboutCellClicked() {
      ...
      storage.getItem(_app_constants.app_bundle_url, function (event) {
        ...
        navigator.push({
          url: event.data + "factorymanager/FMAboutus.js",
          animated: "true"
        }, function (event) {});
      });
    },
    ...
    //修改密码
    changePasswordCellClicked: function changePasswordCellClicked() {
      ...
      storage.getItem(_app_constants.app_bundle_url, function (event) {
        ...
        navigator.push({
          url: event.data + "factorymanager/FMPassword.js",
          animated: "true"
        }, function (event) {});
      });
    },
    ...
    versionCellClicked: function versionCellClicked() {
      storage.getItem(_app_constants.app_bundle_url, function (event) {
        ...
        navigator.push({
          url: event.data + "factorymanager/FMVersion.js",
          animated: "true"
        }, function (event) {});
      });
    },
    ...
    //重新登录
    reloginButtonClicked: function reloginButtonClicked(e) {
      this.Escshow = true;
    },
    ...
    photoFileTakenBefore: function photoFileTakenBefore() {
      ...
      this.photoPath = app_images_url + "photo.png";
      var tkey = this.userId + _app_constants.app_user_photo_path_key;
        ...
        if (event.data != null && event.data != undefined && event.data != "undefined") {
          ...
          if (hadPhoto) {
            (0, _DTSPlugins.YtIsFileExists)({ filePath: userPhotoPath }, function (err, ret) {
              ...
              if (hadPhoto) {
                _this2.photoPath = userPhotoPath;
              } else {
                _this2.photoPath = app_images_url + "photo.png";
              }
            });
          }
        }
  ...
  created: function created() {
    ...
    storage.getItem("app_name", function (event) {
      if (event.result == "success") {
        _this3.userName = event.data;
      }
    });

    storage.getItem(_app_constants.app_userid, function (event) {
      if (event.result == "success") {
        _this3.userId = event.data;

        _this3.photoFileTakenBefore();
      }
    });

    storage.getItem(_app_constants.app_username, function (event) {
      if (event.result == "success") {
        _this3.showUserId = event.data;
      }
    });
  },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["txt-tag"]
  }, [_vm._v(_vm._s(_vm.showUserId))])])]), _c('div', {
    staticClass: ["fbs"]
  }, [_c('div', {
    ...
    on: {
      "wxcCellClicked": _vm.changePasswordCellClicked
    }
  }, [_c('text', {
    ...
    on: {
      "wxcCellClicked": _vm.messageCellClicked
    }
  }, [_c('text', {
    staticClass: ["iconfont"],
    staticStyle: {
    ...
    staticClass: ["button-text"],
    on: {
      "click": _vm.reloginButtonClicked
    }
  }, [_vm._v("退出账号")])]), _c('wxc-dialog', {
    attrs: {
      "title": "温馨提示",
      "show": _vm.Escshow,
      "single": false,
...
module.exports = {
  ...
  "row-content-top-first": {
    "width": "144"
  },
  "row-content-top-last": {
    "width": "190"
  },
  "hcWidth": {
    "width": "140"
...
exports.default = {
  name: 'FMDkAssign',
  components: { WxcCell: _weexUi.WxcCell, WxcPopover: _weexUi.WxcPopover, WxcIcon: _weexUi.WxcIcon, WxcDialog: _weexUi.WxcDialog, WxcLoading: _weexUi.WxcLoading, WxcMinibar: _weexUi.WxcMinibar },
  data: function data() {
    return {
      userId: '', // 登录的用户id
      setSelectValue: 2, // 缓冲区2、垛口区1 
      hcHeader: {}, // 缓冲头部
      hcList: [], // 缓冲数据
      list: [], // 垛口数据
      itemList: '',
      ...
      selectList: [], // 下拉选项
      selectText: '', // 下拉值
      popoverPosition: { x: -54, y: 300 },
      popoverArrowPosition: { pos: 'right', x: -26 },
      posY: 0,
      sQueueId: '', // 队列id
      switchValue: 0, // 滑动按钮
      switchTitle: '手动叫号',
      show: false, // 弹窗显示
      isCheckedDL: false, // 弹窗选中
  ...
  created: function created() {
    ...
    if (this.isipx) {
      this.scrollHeight = bodyHeight - 416;
    } else if (this.isiphone) {
      this.scrollHeight = bodyHeight - 355;
    } else {
      this.scrollHeight = bodyHeight - 355;
    }
    // 初始化字体图标
    ...
    this.isShow = true;
    // 获取用户id
    storage.getItem("sUserID", function (event) {
      _this2.userId = event.data;
      // 调用队列下拉接口
      stream.fetch({
        method: 'GET',
        url: app_server_url + 'Stack_Scheduling/GetFactoryQueueList?sUserID=' + event.data,
        type: 'json'
      }, function (ret) {
        ret.data.Data.QueueList.forEach(function (val) {
          val.checked = false;
        });
        // 绑定下拉
        _this.selectList = ret.data.Data.QueueList;
        _this.selectText = ret.data.Data.QueueList[0].text;
        _this.sQueueId = ret.data.Data.QueueList[0].id;

        // 缓冲区
        _this2.GetBufferTitleInfo(_this.sQueueId);
        _this2.GetBufferTruckList(_this.sQueueId);
        // 初始化列表数据
        _this2.GetParkingSpaceList(_this.sQueueId);

        // 初始化按钮状态
        _this2.GetFactoryQueueState(_this.sQueueId);
      });
    });
  },
  ...
  methods: {
    // 缓冲区2、垛口区1 
    getSwitch: function getSwitch(index) {
      var _this3 = this;

      // 相同时不刷新
      if (this.setSelectValue == index) return;
      this.setSelectValue = index;
      // 显示隐藏
      this.isShow = true;
      // 缓冲区2、垛口区1 
      if (this.setSelectValue == 2) {
        // 缓冲区
        setTimeout(function () {
          _this3.GetBufferTitleInfo(_this3.sQueueId);
          _this3.GetBufferTruckList(_this3.sQueueId);
        });
      } else if (this.setSelectValue == 1) {
        // 垛口区
        setTimeout(function () {
          _this3.GetParkingSpaceList(_this3.sQueueId);
        });
      }
    },
    ...
    viewappear: function viewappear() {
      ...
      /** 
      // 记忆数据
      storage.getItem("selectValue", events => { 
        if(events.data != 'undefined' &&  events.data != '' &&  events.data != null){
          let selectData = JSON.parse(events.data);
          _this.selectText = selectData.text;
          _this.sQueueId = selectData.id;
          // 初始化区
          _this.setSelectValue = selectData.setSelectValue;
           // 缓冲区2、垛口区1 
          if(this.setSelectValue==2){
            // 缓冲区
            this.GetBufferTitleInfo(_this.sQueueId);
            this.GetBufferTruckList(_this.sQueueId);
          }else if(this.setSelectValue==1){
            // 垛口区
            this.GetParkingSpaceList(_this.sQueueId);
          }
        }
         // 清空存储的下拉
        storage.removeItem('selectValue');
    ...
    switchChange: function switchChange() {
      ...
      if (this.switchValue) {
        this.switchTitle = '自动叫号';
      } else {
        this.switchTitle = '手动叫号';
      }
      // 刷新列表
      this.GetParkingSpaceList(this.sQueueId);
      // 点击开关时更新状态
      stream.fetch({
        method: 'POST',
        url: app_server_url + 'Stack_Scheduling/UpdateFactoryQueueState?sQueueId=' + this.sQueueId + '&sState=' + (this.switchValue ? 1 : 0) + '&sUserid=' + this.userId,
        type: 'json'
      }, function (ret) {
    ...
    // 叫号、重叫
    reCall: function reCall(item) {
      var _this4 = this;

      var num = this.$getConfig().bundleUrl.indexOf("FMTabs.js");
      var bundleUrl = this.$getConfig().bundleUrl.substr(0, num);

      // 类型、id/名称
      item.sInType = this.setSelectValue;
      storage.setItem('itemList', JSON.stringify(item));
      // 存储select选项;
      var sQueueId = null;
      this.selectList.forEach(function (val) {
        if (val.text == _this4.selectText) {
          sQueueId = val;
        }
      });
      // 添加哪个区
      sQueueId.setSelectValue = this.setSelectValue;
      storage.setItem('selectValue', JSON.stringify(sQueueId));
      storage.setItem('jhType', 1);

      navigator.push({
        url: bundleUrl + "FMVehicle.js",
        animated: "true"
      }, function (event) {});
    },
    ...
    refreshList: function refreshList() {
      ...
      // 手动叫号、自动叫号开头接口
      this.GetFactoryQueueState(this.sQueueId);
      // 缓冲区2、垛口区1 
      if (this.setSelectValue == 2) {
        // 缓冲区
        this.GetBufferTitleInfo(this.sQueueId);
        this.GetBufferTruckList(this.sQueueId);
      } else if (this.setSelectValue == 1) {
        // 垛口区
        this.GetParkingSpaceList(this.sQueueId);
      }
      ...
      // 更新状态
      storage.setItem('backRefresh', false);
    },
    scrollHandler: function scrollHandler(e) {
      this.posY = e.contentOffset.y;
    },

    // 气泡事件
    jumpPopover: function jumpPopover(index, item) {
      // 手动时气泡取消
      if (this.switchValue) {
        // 气泡值
        if (item.OpenCloseFlag == 1) {
          this.btns = [{ text: '关闭', key: 'key-scan' }, { text: '插队', key: 'key-queue' }];
        } else {
          this.btns = [{ text: '打开', key: 'key-scan' }];
        }
      } else {
        if (item.OpenCloseFlag == 1) {
          this.btns = [{ text: '关闭', key: 'key-scan' }]; // ,{text: '调整垛口',key: 'key-stack'}
        } else {
          this.btns = [{ text: '打开', key: 'key-scan' }];
        }
      }
      ...
      if (this.isipx) {
        this.popoverPosition = { x: -54, y: 466 + num + this.posY };
      } else if (this.isiphone) {
        this.popoverPosition = { x: -54, y: 466 + num + this.posY };
      } else {
        this.popoverPosition = { x: -54, y: 346 + num + this.posY };
      }
    ...
    popoverButtonClicked: function popoverButtonClicked(obj) {
      ...
      if (obj.index == 0) {
        ...
        stream.fetch({
          method: 'POST',
          url: app_server_url + 'Stack_Scheduling/UpdateParkingOpenClose?sSpaceID=' + this.itemList.SpaceID + '&sOpenFlag=' + (this.itemList.OpenCloseFlag == 1 ? 0 : 1),
          type: 'json'
        }, function (ret) {
          if (ret.statusText == 'OK') {
            // 调用列表
            _this5.GetParkingSpaceList(_this5.sQueueId);
          } else {
            // modal.toast({ message:  '网络访问失败'  });
          }
        });
      } else if (obj.key == 'key-queue') {
        // 防止空垛口
        if (this.itemList.TruckID == null) {
          modal.toast({ message: '空垛口不能插队' });
          return;
        }
        // 插队
        // 存储队列id
        storage.setItem('jhType', 2);
        this.itemList.sInType = this.setSelectValue;
        storage.setItem('itemList', JSON.stringify(this.itemList));
        // 存储select选项;
        var sQueueId = null;
        this.selectList.forEach(function (val) {
          if (val.text == _this5.selectText) {
            sQueueId = val;
          }
        });
        // 添加哪个区
        ...
        // 添加哪个区
        _sQueueId.setSelectValue = this.setSelectValue;
        storage.setItem('selectValue', JSON.stringify(_sQueueId));
        // 跳转
        navigator.push({
          url: bundleUrl + "FMStack.js",
          animated: "true"
        }, function (event) {});
      }
    },
    ...
    wxcDialogConfirmBtnClicked: function wxcDialogConfirmBtnClicked() {
      //此处必须设置，组件为无状态组件，自己管理
      this.show = false;
      var sQueueId = this.selectList.filter(function (val) {
        return val.checked;
      });
      this.sQueueId = sQueueId[0].id;
      this.selectText = sQueueId[0].text;
    ...
    // 缓冲区头部
    GetBufferTitleInfo: function GetBufferTitleInfo(sQueueId) {
      var _this6 = this;

      stream.fetch({
        method: 'GET',
        url: app_server_url + 'Stack_Scheduling/GetBufferTitleInfo?sQueueId=' + sQueueId,
        type: 'json'
      }, function (ret) {
        // 关闭loading
        _this6.isShow = false;
        if (ret.statusText == 'OK') {
          if (ret.data.Data.result.length == 0) {
            _this6.hcHeader = {
              BufferID: '',
              BufferName: '',
              UseNumber: '',
            ...
            _this6.hcHeader = ret.data.Data.result[0];
          }
        } else {
          _this6.hcHeader = {
            BufferID: '',
    ...
    // 获取缓冲区列表数据
    GetBufferTruckList: function GetBufferTruckList(sQueueId) {
      var _this7 = this;

      stream.fetch({
        method: 'GET',
        url: app_server_url + 'Stack_Scheduling/GetBufferTruckList?sQueueId=' + sQueueId,
        type: 'json'
      }, function (ret) {
        // 关闭loading
        _this7.isShow = false;
        if (ret.statusText == 'OK') {
          _this7.hcList = ret.data.Data.result;
        } else {
          _this7.hcList = [];
        }
      });
    ...
    // 修改滑动状态
    GetFactoryQueueState: function GetFactoryQueueState(sQueueId) {
      var _this = this;
      stream.fetch({
        method: 'GET',
        url: app_server_url + 'Stack_Scheduling/GetFactoryQueueState?sQueueId=' + sQueueId,
        type: 'json'
      }, function (ret) {
        if (ret.statusText == 'OK') {
          _this.switchValue = ret.data.Data.QueueState[0].isAuto == "1" ? true : false;
        } else {
          //modal.toast({ message:  '网络访问失败'  });
        }
      });
    ...
    // 获取垛口列表数据
    GetParkingSpaceList: function GetParkingSpaceList(sQueueId) {
      var _this8 = this;

      stream.fetch({
        method: 'GET',
        url: app_server_url + 'Stack_Scheduling/GetParkingSpaceList?sQueueId=' + sQueueId,
        type: 'json'
      }, function (ret) {
        // 关闭loading
        _this8.isShow = false;
        if (ret.statusText == 'OK') {
          _this8.list = ret.data.Data.ParkingSpaceList;
        } else {
          _this8.list = [];
        }
      });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcMinibarRightButtonClicked": _vm.rightButton
    }
  }, [_c('text', {
    staticClass: ["iconfont"],
    staticStyle: {
    ...
    staticClass: ["switchLeft"],
    class: [_vm.setSelectValue == 2 ? 'switchActive' : ''],
    staticStyle: {
      position: "absolute",
      left: "30px",
      fontSize: "30px"
    ...
    staticClass: ["switchLeft"],
    class: [_vm.setSelectValue == 1 ? 'switchActive' : ''],
    staticStyle: {
      position: "absolute",
      left: "170px",
      fontSize: "30px"
  ...
  }, [_vm._v(_vm._s(_vm.switchValue == 1 ? "自动叫号" : "手动叫号"))])]), _c('div', {
    staticClass: ["select"]
  }, [_c('text', {
  ...
  }, [_vm._v(_vm._s(_vm.selectText))]), _c('text', {
    ...
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          _vm.dialogSelection(item)
        }
      }
    }, [(item.checked) ? _c('text', {
      staticClass: ["iconfont", "dialog-content-icon", "red"]
    }, [_vm._v("")]) : _c('text', {
      staticClass: ["iconfont", "dialog-content-icon"]
    }, [_vm._v("")]), _c('text', {
      staticClass: ["dialog-content-text"]
    }, [_vm._v(_vm._s(item.text))])])
  }))]), _c('scroller', {
  ...
  }, [(_vm.setSelectValue == 2) ? _c('div', [(_vm.hcHeader.BufferID != '') ? _c('div', {
    staticClass: ["hcHeader"]
  }, [_c('text', {
    staticClass: ["hcHeader-text"]
  }, [_vm._v("缓冲区编号：" + _vm._s(_vm.hcHeader.BufferID))]), _c('text', {
    staticClass: ["hcHeader-text"]
  }), (!_vm.switchValue) ? _c('text', {
    staticClass: ["row-right-button", "hcHeader-pos"],
    on: {
      "click": function($event) {
        _vm.reCall(_vm.hcHeader)
      }
    }
  }, [_vm._v("叫号")]) : _vm._e(), _c('text', {
    staticClass: ["hcHeader-text"]
  }, [_vm._v(_vm._s(_vm.hcHeader.BufferName))]), _c('text', {
    staticClass: ["hcHeader-text"],
    staticStyle: {
      textAlign: "right"
    }
  }, [_vm._v("当前占用数：" + _vm._s(_vm.hcHeader.UseNumber) + " / " + _vm._s(_vm.hcHeader.Number))])]) : _vm._e(), _vm._l((_vm.hcList), function(item) {
    return _c('div', {
      key: item,
      staticClass: ["row-body1"]
    }, [_c('div', {
      staticStyle: {
        width: "720px"
      }
    }, [(item.SType == 0) ? _c('div', {
      staticClass: ["row-left", "hcRow-left", "graybg"]
    }, [_c('text', {
      staticClass: ["row-left-top", "font30", "white"]
    }, [_vm._v("车牌")]), _c('text', {
      staticClass: ["row-left-bottom", "white"]
    }, [_vm._v(_vm._s(item.TruckID == null ? '--' : item.TruckID))])]) : (item.SType == 1) ? _c('div', {
      staticClass: ["row-left", "hcRow-left", "bluebg"]
    }, [_c('text', {
      staticClass: ["row-left-top", "font30", "white"]
    }, [_vm._v("车牌")]), _c('text', {
      staticClass: ["row-left-bottom", "white"]
    }, [_vm._v(_vm._s(item.TruckID == null ? '--' : item.TruckID))])]) : (item.SType == 2) ? _c('div', {
      staticClass: ["row-left", "hcRow-left", "greenbg"]
    }, [_c('text', {
      staticClass: ["row-left-top", "font30", "white"]
    }, [_vm._v("车牌")]), _c('text', {
      staticClass: ["row-left-bottom", "white"]
    }, [_vm._v(_vm._s(item.TruckID == null ? '--' : item.TruckID))])]) : _vm._e(), _c('div', {
      staticClass: ["row-content", "hcRow-content"]
    }, [_vm._m(0, true), _c('div', {
      staticStyle: {
        flexDirection: "row"
      }
    }, [_c('text', {
      staticClass: ["row-content-bottom", "hcWidth"]
    }, [_vm._v(_vm._s(item.TransportType == '' ? '--' : item.TransportType))]), _c('text', {
      staticClass: ["row-content-bottom", "hcWidth"]
    }, [_vm._v(_vm._s(item.TransState == null ? '--' : item.TransState))]), _c('text', {
      staticClass: ["row-content-bottom", "hcWidths"]
    }, [_vm._v(_vm._s(item.TruckTypeName == null ? '--' : item.TruckTypeName))]), _c('text', {
      staticClass: ["row-content-bottom", "hcWidth"]
    }, [_vm._v(_vm._s(item.TruckLengthName == null ? '--' : item.TruckLengthName))])])])])])
  }), (_vm.hcList.length == 0) ? _c('text', {
    staticStyle: {
      textAlign: "center",
      marginTop: "200px",
      color: "#999",
  ...
  }, [_vm._v("当前没有缓冲区列表")]) : _vm._e()], 2) : (_vm.setSelectValue == 1) ? _c('div', [_vm._l((_vm.list), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: ["row-body"],
      on: {
        "longpress": function($event) {
          _vm.jumpPopover(index, item)
        }
      }
    }, [(item.SpaceStatus == 0) ? _c('div', {
      staticClass: ["row-left", "bluebg"],
      class: [item.IsWaring == 'Y' ? 'orangebg' : '']
    }, [_c('text', {
      staticClass: ["row-left-top", "white"]
    }, [_vm._v(_vm._s(item.Spacecode))]), _c('text', {
      staticClass: ["row-left-bottom", "white"]
    }, [_vm._v(_vm._s(item.SpaceType))])]) : (item.SpaceStatus == 1) ? _c('div', {
      staticClass: ["row-left", "graybg"],
      class: [item.IsWaring == 'Y' ? 'orangebg' : '']
    }, [_c('text', {
      staticClass: ["row-left-top", "white"]
    }, [_vm._v(_vm._s(item.Spacecode))]), _c('text', {
      staticClass: ["row-left-bottom", "white"]
    }, [_vm._v(_vm._s(item.SpaceType))])]) : (item.SpaceStatus == 2) ? _c('div', {
      staticClass: ["row-left", "greenbg"],
      class: [item.IsWaring == 'Y' ? 'orangebg' : '']
    }, [_c('text', {
      staticClass: ["row-left-top", "white"]
    }, [_vm._v(_vm._s(item.Spacecode))]), _c('text', {
      staticClass: ["row-left-bottom", "white"]
    }, [_vm._v(_vm._s(item.SpaceType))])]) : _vm._e(), _c('div', {
      ...
      staticClass: ["row-content-bottom", "row-content-top-first"]
    }, [_vm._v(_vm._s(item.TruckID == null ? '--' : item.TruckID))]), _c('text', {
      staticClass: ["row-content-bottom"]
    }, [_vm._v(_vm._s(item.UseDate == '' ? '--' : item.UseDate))]), _c('text', {
      staticClass: ["row-content-bottom", "row-content-top-last", "font22"]
    }, [_vm._v(_vm._s(item.Bill_Id == null ? '--' : item.Bill_Id))])])]), _c('div', {
      staticClass: ["row-right"]
    }, [(item.OpenCloseFlag == 0) ? _c('text', {
      staticClass: ["row-right-text", "iconfont"]
    }, [_vm._v("")]) : (item.OpenCloseFlag == 1 && !_vm.switchValue && item.SpaceStatus == 0) ? _c('text', {
      staticClass: ["row-right-text", "row-right-button", "bluebg"],
      on: {
        "click": function($event) {
          _vm.reCall(item)
        }
      }
    }, [_vm._v("重叫")]) : (item.OpenCloseFlag == 1 && !_vm.switchValue && item.SpaceStatus == 1) ? _c('text', {
      staticClass: ["row-right-text", "row-right-button", "graybg"],
      on: {
        "click": function($event) {
          _vm.reCall(item)
        }
      }
    }, [_vm._v("叫号")]) : (item.OpenCloseFlag == 1 && !_vm.switchValue && item.SpaceStatus == 2) ? _c('text', {
      staticClass: ["row-right-text"]
    }) : _vm._e()])])
  }), (_vm.list.length == 0) ? _c('text', {
    staticStyle: {
      textAlign: "center",
      marginTop: "200px",
      color: "#999",
  ...
  }, [_vm._v("当前没有垛口")]) : _vm._e()], 2) : _vm._e()]), _c('wxc-popover', {
    ref: "wxc-popover1",
    attrs: {
      "buttons": _vm.btns,
  ...
  return _c('div', {
    ...
    staticClass: ["row-content-top", "hcWidth"]
  }, [_vm._v("配送自提")]), _c('text', {
    staticClass: ["row-content-top", "hcWidth"]
  }, [_vm._v("运输类型")]), _c('text', {
    staticClass: ["row-content-top", "hcWidths"]
  }, [_vm._v("车型")]), _c('text', {
    staticClass: ["row-content-top", "hcWidth"]
  }, [_vm._v("车长")])])
  ...
  return _c('div', {
    ...
    staticClass: ["row-content-top", "row-content-top-first"]
  }, [_vm._v("车牌")]), _c('text', {
    staticClass: ["row-content-top"]
  }, [_vm._v("占用时长")]), _c('text', {
    staticClass: ["row-content-top", "row-content-top-last"]
  }, [_vm._v("调度单号")])])
}]}
module.exports.render._withStripped = true
...
module.exports = {
  ...
  "scrollerWarp": {
    ...
    "left": 0,
    "bottom": 200,
    "backgroundColor": "rgb(144,181,250)"
  },
  "scrollerTop160": {
    "top": 360
  },
...
exports.default = {
  name: 'FMQueueAssign',
  components: { WxcMinibar: _weexUi.WxcMinibar, WxcCell: _weexUi.WxcCell, WxcIcon: _weexUi.WxcIcon, WxcPopup: _weexUi.WxcPopup, WxcGridSelect: _weexUi.WxcGridSelect, WxcLoading: _weexUi.WxcLoading },
  data: function data() {
    return {
      customStyles: {
      ...
      isTopShow: false,
      selectList: [],
      selectListClone: [], // 复制下拉用于取值
      selectText: {}, // 初始下拉对象
      testData2: [{ 'title': '全选', 'checked': true, 'value': 2 }, { 'title': '卸货', 'checked': false, 'value': 0 }, { 'title': '装货', 'checked': false, 'value': 1 }],
      testData3: [{ 'title': '全选', 'checked': true, 'value': 2 }, { 'title': '厂外', 'checked': false, 'value': 0 }, { 'title': '缓冲区', 'checked': false, 'value': 1 }],
      sLoadingType: 2, // 车辆类型
      sIsInfactory: 2, // 所在区域
      scrollHeight: '' //滚动的高
    };
  ...
  methods: {
    ...
    minibarRightButtonClick: function minibarRightButtonClick() {
      ...
      // 加载数据
      setTimeout(function () {
        _this2.GetQueueInfoQuery(_this2.selectText.id, _this2.sLoadingType, _this2.sIsInfactory);
      }, 1000);
    },

    // 订单详情
    billId: function billId(item) {
      item.Bill_id = item.Bill_Id;
      storage.setItem("objbill", JSON.stringify(item));

      var num = this.$getConfig().bundleUrl.indexOf("FMTabs.js");
      var bundleUrl = this.$getConfig().bundleUrl.substr(0, num);

      navigator.push({
        url: bundleUrl + "FMOrderDetails.js",
        animated: "true"
      }, function (event) {});
    },
    openTopPopup: function openTopPopup() {
      this.isTopShow = true;
    },
    popupOverlayTopClick: function popupOverlayTopClick() {
      this.isTopShow = false;
    },
    pickSelect: function pickSelect(data) {
      var self = this;
      picker.pick({
        ...
        if (result == 'success') {
          self.selectText = self.selectListClone[ret.data];
        }
      });
    },
    onSelect2: function onSelect2(item) {
      this.testData2.forEach(function (val) {
        val.checked = false;
      });
      item.checked = true;
      this.sLoadingType = item.value;
    },
    onSelect3: function onSelect3(item) {
      this.testData3.forEach(function (val) {
        val.checked = false;
      });
      item.checked = true;
      this.sIsInfactory = item.value;
    },
    btnCancel: function btnCancel() {
      // 取消
      this.$refs.wxcPopup.hide();
    },
    btnPut: function btnPut() {
      // 确定
      this.$refs.wxcPopup.hide();

      this.isShow = true;

      this.GetQueueInfoQuery(this.selectText.id, this.sLoadingType, this.sIsInfactory);
    },

    // 获取列表数据
    GetQueueInfoQuery: function GetQueueInfoQuery(a, b, c) {
      var _this = this;
      // _this.isShow = true;
      var mrul = "";
      mrul = app_server_url + 'Stack_Scheduling/GetQueueInfoQuery?sQueueId=' + a + '&sLoadingType=' + b + '&sIsInfactory=' + c;
      ...
      stream.fetch({
        ...
        if (ret.statusText == 'OK') {
          _this.listQ = ret.data.Data.QueueInfo;
        } else {
          _this.listQ = [];
        }
        //关闭loading
  ...
  mounted: function mounted() {
    //this.ref.srcoll.offsetTop;
    // modal.toast({ message:  Utils.env.getPageHeight() });
  },
  created: function created() {
    var _this3 = this;
    ...
    // 列表高度
    var bodyHeight = _weexUi.Utils.env.getScreenHeight();
    if (this.isipx) {
      this.scrollHeight = bodyHeight - 460 - 76 - 80 + 140;
    } else if (this.isiphone) {
      this.scrollHeight = bodyHeight - 375;
    } else {
      this.scrollHeight = bodyHeight - 375;
    }
    ...
    storage.getItem("sUserID", function (event) {
      stream.fetch({
        ...
        if (ret.statusText == 'OK') {
          // 下拉有数据
          if (ret.data.Data.QueueList.length > 0) {
            ret.data.Data.QueueList.forEach(function (element) {
              _this3.selectList.push(element.text);
            });
            _this3.selectListClone = ret.data.Data.QueueList;
            _this3.selectText = ret.data.Data.QueueList[0];

            // 获取列表数据
            _this3.GetQueueInfoQuery(ret.data.Data.QueueList[0].id, 2, 2);
          }
        } else {
          modal.toast({ message: '网络访问失败' });
        }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcPopupOverlayClicked": _vm.popupOverlayTopClick
    }
  }, [_c('div', {
    staticClass: ["queueF", "filterBorder"],
    class: [_vm.isipx ? 'w-ipxTop' : '']
  }, [_c('div', {
    staticClass: ["queueF-left"]
  }, [_c('text', {
    staticClass: ["iconfont", "font30"],
    staticStyle: {
      marginLeft: "10px"
    }
  }, [_vm._v(" 筛选")])])]), _c('text', {
    staticClass: ["popup-title", "font30"]
  }, [_vm._v("所属列队")]), _c('div', {
    staticClass: ["select"]
  }, [_c('text', {
    staticClass: ["select-text", "font30"],
    on: {
      "click": _vm.pickSelect
    }
  }, [_vm._v(_vm._s(_vm.selectText.text))]), _c('text', {
    staticClass: ["iconfont", "select-icon", "font30"],
    on: {
      "click": _vm.pickSelect
    }
  }, [_vm._v("")])]), _c('text', {
  ...
  }, _vm._l((_vm.testData2), function(item, index) {
    return _c('text', {
      key: index,
      staticClass: ["popup-list-text"],
      style: item.checked ? _vm.customStyles : {
        borderColor: 'rgb(242, 242, 242)',
        backgroundColor: 'rgb(242, 242, 242)'
      },
      on: {
    ...
    staticClass: ["popup-list"]
  }, _vm._l((_vm.testData3), function(item) {
    return _c('text', {
      key: item,
      staticClass: ["popup-list-text"],
      style: item.checked ? _vm.customStyles : {
    ...
    staticClass: ["popup-btn-cancel", "font30"],
    on: {
      "click": _vm.btnCancel
    }
  }, [_vm._v("取消")]), _c('text', {
    staticClass: ["popup-btn-put", "font30"],
    on: {
      "click": _vm.btnPut
    }
  }, [_vm._v("确定")])])]), _vm._m(0), _c('scroller', {
    staticClass: ["scroller"],
    style: {
      height: _vm.scrollHeight
    }
  }, [_vm._l((_vm.listQ), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: ["veh-header", "veh-body"]
    }, [_c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.SerialNumber))]), _c('text', {
      staticClass: ["veh-header-text"],
      class: [item.StatusName == '等待' ? 'blue' : '', item.StatusName == '叫号中' ? 'orange' : '']
    }, [_vm._v(_vm._s(item.StatusName))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.TruckNo))]), _c('text', {
      staticClass: ["veh-header-text", "font24"]
    }, [_vm._v(_vm._s(item.TruckTypeName))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.RecommendSpaceID))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.WaitTime))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.CommodityCode))]), _c('text', {
      staticClass: ["veh-header-text", "bluet"],
      on: {
        "click": function($event) {
          _vm.billId(item)
        }
  ...
  }), (_vm.listQ.length == 0) ? _c('text', {
    staticStyle: {
      textAlign: "center",
      marginTop: "50px"
    }
  }, [_vm._v("目前没有队列")]) : _vm._e()], 2)], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["veh-header"]
  }, [_c('text', {
    staticClass: ["veh-header-text", "veh-header-textB"]
  }, [_vm._v("序号")]), _c('text', {
    staticClass: ["veh-header-text", "veh-header-textB"]
  }, [_vm._v("状态")]), _c('text', {
    staticClass: ["veh-header-text", "veh-header-textB"]
...
var _TMpagesConfig = __webpack_require__(255);

var _TMpagesConfig2 = _interopRequireDefault(_TMpagesConfig);
...
exports.default = {
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcButton: _weexUi.WxcButton, WxcIcon: _weexUi.WxcIcon, WxcPageCalendar: _weexUi.WxcPageCalendar, WxcTabPage: _weexUi.WxcTabPage, WxcLoading: _weexUi.WxcLoading, WxcDialog: _weexUi.WxcDialog },

    data: function data() {
        return {
            animationType: "push",
            tabTitles: _TMpagesConfig2.default.tabTitles,
            tabStyles: _TMpagesConfig2.default.tabStyles,
            inputBid: '', // 输入查询
            UserId: "",
            serviceCode: "D1",
            tabList: [1, 2, 3, 4],
    ...
    methods: {
        ...
        wxcTabPageCurrentTabSelected: function wxcTabPageCurrentTabSelected(e) {
            ...
            this.serviceCode = this.tabTitles[index].serviceCode;

            storage.setItem('TMHistoryOrdersCurrentServiceCode', this.serviceCode, function (event) {});
            this.contentRefresh();
        },

        // 打开弹窗
        openMark: function openMark(item, index) {
            this.show = true;
            // 保存数据
            this.itemList = item;
        ...
        // 取消
        markCancel: function markCancel() {
            this.show = false;
        },

        // 确定
        markConfirm: function markConfirm() {
            this.show = false;

            this.close(this.itemList, this.itemIndex);
        },
        ...
        jumpOrderDetails: function jumpOrderDetails(item) {
            storage.setItem('objbill', JSON.stringify(item), function (event) {});
            storage.getItem("app_bundle_url", function (event) {
                if (event.data === undefined || event.data === null) {
                    return;
                }
                navigator.push({
                    url: event.data + "factorymanager/FMOrderDetails.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        jump: function jump(item) {
            storage.setItem('TMHistoryOrdersBill_id', JSON.stringify(item), function (event) {});
            storage.getItem("app_bundle_url", function (event) {
                if (event.data === undefined || event.data === null) {
                    return;
                }
                navigator.push({
                    url: event.data + "factorymanager/FMAssessDetail.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        close: function close(item, index) {
            ...
            stream.fetch({
                method: "DELETE",
                url: app_server_url + "Stack_Scheduling/DeleteTsetContentedInfo?sBillId=" + item.Bill_id + "&sQueueId=" + item.QueueID,
                type: "json"
            }, function (ret) {
        ...
        contentRefresh: function contentRefresh() {
            ...
            stream.fetch({
                method: "GET",
                url: app_server_url + "Stack_Scheduling/GetBillEvaluate?serviceCode=" + this.serviceCode + "&UserID=" + this.UserId + "&sStarDate=" + this.startDate + "&sEndDate=" + this.endDate + "&sBillId=" + bid, //this.UserId
                type: "json"
            }, function (ret) {
                _this2.isShowLoadding = false;
                ...
                if (ret.ok === false) {
                    ...
                    // modal.toast({ message: JSON.stringify(ret.data.Data.result) });
                    _this2.lists = ret.data.Data.result;
                }
            });
        },
        ...
        //选择开始日期
        clickStartDate: function clickStartDate() {
            var _this3 = this;
        ...
        //选择结束日期
        clickEndDate: function clickEndDate() {
            var _this4 = this;
            ...
            picker.pickDate({
                ...
                if (event.result === 'success') {
                    _this4.endDate = event.data;
                }
            });
        },
        clickCommitBtn: function clickCommitBtn() {

            if (this.startDate === '2016-1-1') {
                modal.toast({ message: "请选择开始日期" });
                return;
            } else if (this.endDate === '2020-12-31') {
                modal.toast({ message: "请选择结束日期" });
                return;
            }
        ...
        http: function http() {
            ...
            storage.getItem(_app_constants.app_userid, function (event) {
                if (event.result == "success") {
                    _this5.UserId = event.data;

                    _this5.contentRefresh();
                }
            });
        }
    },
    ...
    created: function created() {
        ...
        var bodyHeight = _weexUi.Utils.env.getScreenHeight();
        this.tabPageHeight = bodyHeight;

        if (this.isipx) {
            this.scrollHeight = bodyHeight - 655;
        } else if (this.isiphone) {
            this.scrollHeight = bodyHeight - 549;
        } else {
            this.scrollHeight = bodyHeight - 549;
        }
        ...
        // 获取日期
        var yesterdsay = new Date(new Date().getTime() - 24 * 60 * 60 * 1000);
        var fyear = yesterdsay.getFullYear();
        var fmonth = yesterdsay.getMonth() + 1;
        var fday = yesterdsay.getDate();
        ...
        this.startDate = fyear + "-" + fmonth + "-" + fday;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["datetext", "iconfont"],
    on: {
      "click": _vm.clickStartDate
    }
  }, [_vm._v("  " + _vm._s(_vm.startDate))]), _c('text', {
    staticClass: ["zhi-text"]
  }, [_vm._v("至")]), _c('text', {
    staticClass: ["datetext", "iconfont"],
    on: {
      "click": _vm.clickEndDate
    }
    ...
    on: {
      "input": function($event) {
        _vm.inputBid = $event.target.attr.value
      }
    }
  }), _c('text', {
    staticClass: ["commitBtn"],
    on: {
      "click": _vm.clickCommitBtn
    }
  }, [_vm._v("确定")])])]), _c('wxc-tab-page', {
    ref: "wxc-tab-page",
    attrs: {
    ...
    return _c('div', {
      ...
      style: {
        height: (_vm.tabPageHeight - _vm.tabStyles.height - 398) + 'px'
      }
    }, [_c('list', {
      staticClass: ["list"],
      style: {
      ...
      return _c('cell', {
        ...
        staticClass: ["KAOrder"]
      }, [_vm._v("调度单号:" + _vm._s(item.Bill_id))]), _c('text', {
        staticClass: ["cell-time", "textRight"],
        class: [item.isEvaluate == 'N' ? 'pdRight30' : '']
      }, [_vm._v(_vm._s(item.handeTime))])]), _c('div', {
        staticClass: ["cMz"]
      }, [_c('text', {
        staticClass: ["cName"]
      }, [_vm._v("司机")]), _c('text', {
        staticClass: ["cName-content", "textRight"]
      }, [_vm._v(_vm._s(item.DriverName))]), _c('text', {
        staticClass: ["cName"]
      }, [_vm._v("承运商")]), _c('text', {
        staticClass: ["cName-content", "textRight"]
      }, [_vm._v(_vm._s(item.CarrierName))])]), _c('div', {
        staticClass: ["panel-address"]
      }, [_c('text', {
        staticClass: ["iconfont", "cell-shop-icon"]
      }, [_vm._v("")]), _c('text', {
        staticClass: ["address"]
      }, [_vm._v(_vm._s(item.destinationName))]), _c('text', {
        staticClass: ["iconfont", "cell-shop-icon", "orange"]
      }, [_vm._v("")]), _c('text', {
        staticClass: ["address"]
      }, [_vm._v(_vm._s(item.toShpgLocName))])])]), (item.isEvaluate == 'N') ? _c('text', {
        staticClass: ["iconfont", "panel-close"],
        on: {
          "click": function($event) {
            _vm.openMark(item, index)
          }
        }
        ...
        staticClass: ["cell-license-number"],
        class: [item.isEvaluate == 'N' ? 'orange' : '']
      }, [_vm._v(_vm._s(item.TmsCount) + "张订单:" + _vm._s(item.CodeList))]), (item.isEvaluate == 'N') ? _c('text', {
        staticClass: ["iconfont", "cell-Evaluate", "textRight", "orange"]
      }, [_vm._v("未评价 ")]) : (item.isEvaluate == 'Y') ? _c('text', {
        staticClass: ["iconfont", "cell-Evaluate", "textRight"]
      }, [_vm._v("已评价 ")]) : _vm._e()])])])
    }), (_vm.lists.length == 0) ? _c('cell', {
      staticClass: ["nodata-cell"],
      appendAsTree: true,
      attrs: {
        "append": "tree"
      }
    ...
    on: {
      "wxcDialogCancelBtnClicked": _vm.markCancel,
      "wxcDialogConfirmBtnClicked": _vm.markConfirm
    }
  }, [_c('div', {
    attrs: {
      "slot": "content"
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMMy.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-550fea58"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMTabs.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e6e66342"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _FMTabsConfig = __webpack_require__(388);

var _FMTabsConfig2 = _interopRequireDefault(_FMTabsConfig);

var _FMDkAssign = __webpack_require__(389);

var _FMDkAssign2 = _interopRequireDefault(_FMDkAssign);

var _FMQueueAssign = __webpack_require__(390);

var _FMQueueAssign2 = _interopRequireDefault(_FMQueueAssign);

var _TMHistoryOrders = __webpack_require__(391);

var _TMHistoryOrders2 = _interopRequireDefault(_TMHistoryOrders);

var _TMMy = __webpack_require__(257);

var _TMMy2 = _interopRequireDefault(_TMMy);
...
exports.default = {
  name: 'FMTabs',
  components: { WxcTabBar: _weexUi.WxcTabBar, FMDkAssign: _FMDkAssign2.default, FMQueueAssign: _FMQueueAssign2.default, TMHistoryOrders: _TMHistoryOrders2.default, FMMy: _TMMy2.default },
  data: function data() {
    return {
      tabTitles: _FMTabsConfig2.default.tabTitles,
      tabStyles: _FMTabsConfig2.default.tabStyles
    };
  },
  created: function created() {
    //setTitle('TabBar');
  ...
  methods: {
    viewappear: function viewappear() {
      ...
      // 垛口叫号成功时刷新接口
      storage.getItem('backRefresh', function (event) {
        if (event.data === undefined || event.data === null) {
          return;
        } else if (event.data == 'true') {
          _this.$refs.FMDkAssign.refreshList();
        }
        storage.removeItem('backRefresh');
      });

      // 历史订单评价成功时刷新
      storage.getItem('historyRefresh', function (event) {
        if (event.data === undefined || event.data === null) {
          return;
        } else if (event.data == 'true') {
          _this.$refs.TMHistoryOrders.clickCommitBtn();
        }
        storage.removeItem('historyRefresh');
      });
    },
...
exports.default = {
  ...
  tabTitles: [{
    title: '垛口调度',
    icon: _app_constants.app_images_url + 'dk_assign.png', //'https://gw.alicdn.com/tfs/TB1MWXdSpXXXXcmXXXXXXXXXXXX-72-72.png',
    activeIcon: _app_constants.app_images_url + 'dk_assign_sel.png' //'https://gw.alicdn.com/tfs/TB1kCk2SXXXXXXFXFXXXXXXXXXX-72-72.png'
  }, {
    title: '队列状态',
    icon: _app_constants.app_images_url + 'queue_status.png', //'https://gw.alicdn.com/tfs/TB1ARoKSXXXXXc9XVXXXXXXXXXX-72-72.png',
    activeIcon: _app_constants.app_images_url + 'queue_status_sel.png' //'https://gw.alicdn.com/tfs/TB19Z72SXXXXXamXFXXXXXXXXXX-72-72.png'
  }, {
    title: '历史订单',
    icon: _app_constants.app_images_url + 'history_orders.png', //'https://gw.alicdn.com/tfs/TB1ARoKSXXXXXc9XVXXXXXXXXXX-72-72.png',
    activeIcon: _app_constants.app_images_url + 'history_orders_sel.png' //'https://gw.alicdn.com/tfs/TB19Z72SXXXXXamXFXXXXXXXXXX-72-72.png'
  }, {
    title: '我的',
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMDkAssign.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-58814a92"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMQueueAssign.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0758cc8f"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/TMHistoryOrders.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-12e253d4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
