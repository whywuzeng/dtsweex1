...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMMessageDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-74d944a7"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  created: function created() {
    ...
    storage.getItem("MessageDetail", function (event) {
      _this.BillStatusReturn = JSON.parse(event.data);
    });
  },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["title", "font30"]
  }, [_vm._v(_vm._s(_vm.BillStatusReturn.Info_type))]), _c('text', {
    staticClass: ["content", "font30"]
  }, [_vm._v("\n        " + _vm._s(_vm.BillStatusReturn.Info_msg) + "\n      ")])])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
