...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMMy.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-bb5dc066"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  name: 'FMMy',
  components: { WxcMinibar: _weexUi.WxcMinibar, WxcCell: _weexUi.WxcCell, WxcButton: _weexUi.WxcButton },
  data: function data() {
    return {
      url: '',
      photoPath: "",
  ...
  methods: {
    ...
    wxcButtonClicked: function wxcButtonClicked(e) {
      var num = this.$getConfig().bundleUrl.indexOf("factorymanager/FMTabs.js");
      ...
      // navigator.pop({animated: "false"}, event => {});
    },
          ...
          if (hadPhoto) {
            (0, _DTSPlugins.YtIsFileExists)({ filePath: userPhotoPath }, function (err, ret) {
              ...
              if (hadPhoto) {
                ...
                _this2.photoPath = _app_constants.app_images_url + "photo.png";
              }
            });
          }
        }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "title": "修改密码",
      "hasArrow": true,
      "link": _vm.url + 'FMPassword.js',
      "hasTopBorder": false
    }
  }, [_c('text', {
    staticClass: ["iconfont"],
    staticStyle: {
      color: "rgb(70,133,192)"
    },
    attrs: {
      "slot": "label"
    },
