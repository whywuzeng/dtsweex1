...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMOrderDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-62155416"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  name: "FMOrderDetails",
  components: { WxcButton: _weexUi.WxcButton, WxcMinibar: _weexUi.WxcMinibar, WxcLoading: _weexUi.WxcLoading, Utils: _weexUi.Utils },
  data: function data() {
    return {
      lists: {
        ListA: [],
  ...
  created: function created() {
    ...
    storage.getItem("objbill", function (event) {
      _this2.BillId = JSON.parse(event.data).Bill_id;

      _this.getImg();

      stream.fetch({
        method: "GET",
        url: app_server_url + "Stack_Scheduling/GetDetailInfoAll?sBillId=" + _this2.BillId,
        type: "json"
      }, function (ret) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), (_vm.lists.ListA.length == 0) ? _c('text', {
    staticStyle: {
      marginTop: "50px",
      textAlign: "center",
      fontSize: "30px"
