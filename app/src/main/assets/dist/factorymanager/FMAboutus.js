...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/factorymanager/FMAboutus.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ad487fcc"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  created: function created() {
    ...
    (0, _DTSPlugins.GetAPPJSVersions)({}, function (err, ret) {
      //let appVersion = ret.appVersion;
      //js版本号ret.jsVersion;上次热更新时间:ret.jsLastUpdateTime ; 上次热更新状态：ret.jsLastUpdateStatus
      _this.appversionnumber = ret.appVersion;
      _this.jsversionnumber = ret.jsVersion;
      _this.datanumber = ret.jsLastUpdateTime;
      //  ${ret.jsLastUpdateStatus};//ret.latitude;
    });
  },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("\n      当前APP版本:" + _vm._s(_vm.appversionnumber) + "\n  ")]), _c('text', {
    staticStyle: {
      paddingLeft: "15px",
      paddingRight: "15px",
      fontSize: "30px"
    }
  }, [_vm._v("\n      当前热更新版本:" + _vm._s(_vm.jsversionnumber) + "\n  ")]), _c('text', {
    staticStyle: {
      paddingLeft: "15px",
      paddingRight: "15px",
      fontSize: "30px"
    }
  }, [_vm._v("\n      更新时间:" + _vm._s(_vm.datanumber) + "\n  ")])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
