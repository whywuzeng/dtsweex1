...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/driver/DriverServiceProgress.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-333ca5d6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  name: "DriverServiceProgress",
  components: { WxcMinibar: _weexUi.WxcMinibar, WxcButton: _weexUi.WxcButton, WxcLoading: _weexUi.WxcLoading, WxcTag: _weexUi.WxcTag, WxcSimpleFlow: _weexUi.WxcSimpleFlow },
  data: function data() {
    return {
      type: "",
      themeColor: {
  ...
  methods: {
    ...
    onSelect1: function onSelect1(data) {
      console.log(data);
    }
  },
  computed: {
  ...
  created: function created() {
    ...
    storage.getItem("objbill", function (event) {
      // _this.type = event.data;
      //  modal.toast({ message: "storage:" + JSON.parse(event.data).DriverID });

      stream.fetch({
        method: "POST",
        url: app_server_url + "APPDriverList/GetDriverBaseList?DriverID=" + JSON.parse(event.data).DriverID + "&TYPE=10&Code=" + JSON.parse(event.data).bill_id,
        type: "json"
      }, function (ret1) {
        if (ret1.ok === false) {
          ...
          _this.toplists.forEach(function (element) {
