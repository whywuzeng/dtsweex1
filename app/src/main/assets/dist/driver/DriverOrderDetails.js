...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/driver/DriverOrderDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4fd39e11"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    getImg: function getImg() {
      var _this = this;
      // modal.toast({ message: _this.bill_id });
      (0, _DTSPlugins.YtQRGenerator)({
        codeValue: _this.bill_id, //必填
  ...
  created: function created() {
    ...
    storage.getItem("objbill", function (event) {
      _this.titlt = JSON.parse(event.data).bill_status_mc;
      _this.bill_id = JSON.parse(event.data).bill_id;
      _this.factoryid_mc = JSON.parse(event.data).factoryid_mc;
      _this.loadid = JSON.parse(event.data).loadid;
      _this.ratecode = JSON.parse(event.data).ratecode;
      _this.carriername = JSON.parse(event.data).carriername;

      _this.getImg();
      stream.fetch({
        method: "POST",
        url: app_server_url + "APPDriverList/GetDriverBILL_Detail_List?DriverID=" + JSON.parse(event.data).DriverID + "&Code=" + JSON.parse(event.data).bill_id + "&TYPE=01",
        ...
        if (ret.ok === false) {
          ...
          stream.fetch({
            method: "POST",
            url: app_server_url + "APPDriverList/GetDriverBILL_Detail_SKU_List?DriverID=" + JSON.parse(event.data).DriverID + "&Code=" + JSON.parse(event.data).bill_id + "&TYPE=01",
            // url: `${app_server_url}APPDriverList/Driver_Security_Select?DriverID=${this.driverID}&shipid=${this.FactoryID}`,
            type: "json"
          }, function (ret) {
            _this.lodinisShow = false;
            if (ret.ok === false) {
              ...
              _this.lists = ret.data.Data.DriverDetail_SKUList;
              // modal.toast({ message: ret.data.Data.DriverDetail_SKUList[0].DestinationName });
            }
          });
        }
      });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["text-siez"]
  }, [_vm._v(_vm._s(_vm.titlt))])]), _c('div', {
    staticClass: ["box-tlt"]
  }, [_c('text', {
    staticClass: ["box-txt"]
  }, [_vm._v("单号")]), _c('text', {
    staticClass: ["i-box-in"]
  }, [_vm._v(_vm._s(_vm.bill_id))])]), _c('div', {
    staticClass: ["box-tlt"]
  }, [_c('text', {
    staticClass: ["box-txt"]
  }, [_vm._v("装货工厂")]), _c('text', {
    staticClass: ["i-box-in"]
  }, [_vm._v(_vm._s(_vm.factoryid_mc))])]), _c('div', {
    staticClass: ["div-lin"]
  }), _c('div', {
    staticClass: ["box-tlt"]
  }, [_c('text', {
    staticClass: ["box-txt"]
  }, [_vm._v("load单号")]), _c('text', {
    staticClass: ["i-box-in"]
  }, [_vm._v(_vm._s(_vm.loadid))])]), _c('div', {
    staticClass: ["box-tlt"]
  }, [_c('text', {
    staticClass: ["box-txt"]
  }, [_vm._v("送达方")]), _c('text', {
    staticClass: ["i-box-in"]
  }, [_vm._v(_vm._s(_vm.carriername))])]), _c('div', {
    staticClass: ["box-tlt"]
  }, [_c('text', {
    staticClass: ["box-txt"]
  }, [_vm._v("路线")]), _c('text', {
    staticClass: ["i-box-in"]
  }, [_vm._v(_vm._s(_vm.ratecode))])]), _c('div', [_c('image', {
    staticClass: ["div-img"],
    attrs: {
      "resize": "stretch",
      "src": _vm.imgurl
