...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/driver/DriverKsResult.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-69ada6bc"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    wxcButtonClicked: function wxcButtonClicked(e) {
      // modal.toast({ message:  "wxcButtonClicked"})
      // let num = this.$getConfig().bundleUrl.indexOf("DriverResult.js");
      // let bundleUrl = this.$getConfig().bundleUrl.substr(0, num);

      // // modal.toast({ message:  bundleUrl+"/"+num})
      // navigator.push(
      //   {
      //     url: bundleUrl + "DriverTabs.js",
      //     animated: "true"
      //   },
      //   event => {}
      // );
      //   const Steve = new BroadcastChannel("EscMsg");
      //   const isBak = 'Y';
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["text-b"]
  }, [_vm._v("系统稍后生成相应的单号")]) : _vm._e()]), _c('div', {
    staticClass: ["div-c"]
  }, [_c('wxc-button', {
  ...
  return _c('div', {
    ...
    attrs: {
      "resize": "stretch",
      "src": "https://tt.ab-inbev.cn/TrackApp/AppUpdate/dtsappimages/Success.png"
    }
  })])
