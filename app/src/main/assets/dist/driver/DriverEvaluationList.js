...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/driver/DriverEvaluationList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-706214b7"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    messageDetail: function messageDetail(item) {
      this.objbill.DriverID = item.DriverID;
      this.objbill.bill_id = item.Turnover_id;
      var objbill = item;
      storage.setItem("objbill", JSON.stringify(objbill));
      var num = this.$getConfig().bundleUrl.indexOf("DriverEvaluationList.js");
  ...
  created: function created() {
    ...
    storage.getItem("messageID", function (event) {
      // modal.toast({ message: "messageID:" + JSON.parse(event.data).DriverID });
      _this2.lodinisShow = true;
      stream.fetch({
        method: "POST",
        url: app_server_url + "APPDriverList/GetDriver_Evaluate_new?DriverID=" + JSON.parse(event.data).DriverID,
        ...
        if (ret.ok === false) {
          ...
          if (ret.data.Data.DriverEvaluateList.length > 0) ret.data.Data.DriverEvaluateList.forEach(function (element) {
            if (element.queueid == "Y") {
              element.isValue = true;
            } else element.isValue = false;
            element.DriverID = JSON.parse(event.data).DriverID;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: ["KAOrder-"]
    }, [_vm._v("订单号:" + _vm._s(item.bill_id))])]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v("工厂名称:" + _vm._s(item.factoryname))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v("列队名称:" + _vm._s(item.queuename))]), (item.isValue) ? _c('text', {
      staticClass: ["veh-header-text-rig", "iconfont"]
    }, [_vm._v("")]) : _c('text', {
      staticClass: ["veh-header-text-rig-top", "iconfont"]
    }, [_vm._v("")])])])
  }))])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
