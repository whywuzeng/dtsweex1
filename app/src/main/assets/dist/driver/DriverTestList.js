...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/driver/DriverTestList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-518cc866"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    messageDetail: function messageDetail(item) {
      ...
      var objbill = item;
      if (item.exam_status == 'Y') {
        modal.toast({ message: "此工厂已通过考试" });
        return;
      }
      storage.setItem("objbill", JSON.stringify(objbill));
      var num = this.$getConfig().bundleUrl.indexOf("DriverTestList.js");
  ...
  created: function created() {
    ...
    storage.getItem("messageID", function (event) {
      ...
      stream.fetch({
        method: "POST",
        url: app_server_url + "APPDriverList/GetDriver_Factory_Exam?DriverID=" + JSON.parse(event.data).DriverID + "&TYPE=01",
        ...
        if (ret.ok === false) {
          ...
          if (ret.data.Data.DriverBaseList.length > 0) ret.data.Data.DriverBaseList.forEach(function (element) {
            if (element.exam_status == "Y") {
              element.isValue = '通过';
            } else element.isValue = '未通过';
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(item.factoryname))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.exam_date))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.exam_sum))]), _c('text', {
      staticClass: ["veh-header-text"]
    }, [_vm._v(_vm._s(item.isValue))])])])])
  }))])], 1)
