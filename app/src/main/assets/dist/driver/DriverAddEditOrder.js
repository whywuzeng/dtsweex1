...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/driver/DriverAddEditOrder.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0cae0b40"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    ...
    bottomrightButtonClick: function bottomrightButtonClick() {
      ...
      if (this.checklist.length == 0) {
        modal.toast({ message: "请选择订单！" });
        return;
      } else if (this.checklist.length > 1) {
        this.checklist.forEach(function (element) {
          if (_this3.checklist.length > 1) if (element.StatusType == "02") {
            valuebool = true;
          }
        });
        if (!valuebool) {
        ...
        this.myurl = app_server_url + "APPDriverList/Driver_BillStatus_Save?DriverID=" + this.DriverID + "&bill_id=" + this.checklist[0].bill_id + "&status=" + this.checklist[0].bill_status + "&TYPE=01&bill_id_sub=" + this.checklist[1].bill_id;
      } else {
        this.myurl = app_server_url + "APPDriverList/Driver_BillStatus_Save?DriverID=" + this.DriverID + "&bill_id=" + this.checklist[0].bill_id + "&status=" + this.checklist[0].bill_status + "&TYPE=05";
      }
  ...
  created: function created() {
    ...
    // modal.toast({
    //   message: "-- 高度 --" + Utils.env.getPageHeight() 
    // });
  }
};
