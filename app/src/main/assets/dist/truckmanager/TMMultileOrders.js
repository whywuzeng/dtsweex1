...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMMultileOrders.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-79e1e302"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcButton: _weexUi.WxcButton, WxcIcon: _weexUi.WxcIcon },
    data: function data() {
        ...
        contentRefresh: function contentRefresh() {
            ...
            stream.fetch({
                ...
                if (ret.ok === false) {
                    ...
                    _this.lists = ret.data.Data.GetBillList;
                }
            });
            ...
            stream.fetch({
                ...
                if (ret.ok === false) {
                    ...
                    _this.assignBillList = ret.data.Data.GetBillList;
                }
            });
        }
    },
    ...
    created: function created() {
        ...
        storage.getItem("AppointmentCodes", function (event) {
            ...
            _this2.sAppointmentCode = event.data;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    return _c('div', {
      ...
      staticClass: ["secondbox"]
    }, _vm._l((_vm.assignBillList), function(item, index) {
      return _c('div', {
        key: index,
        staticClass: ["s-box"]
      }, [_c('text', {
        staticClass: ["s-box-text"]
      }, [_vm._v(_vm._s(item.SKUName))]), _c('text', {
        staticClass: ["s-box-text", "textNum"]
      }, [_vm._v(_vm._s(item.ResidualQuantity) + "箱")])])
    }))])
  }))])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
