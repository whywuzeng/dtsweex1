...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMSubmitFail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-bf7d7104"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    components: { WxcIcon: _weexUi.WxcIcon, WxcButton: _weexUi.WxcButton, WxcMinibar: _weexUi.WxcMinibar },
    ...
    methods: {
        backButtonClicked: function backButtonClicked(e) {
            navigator.pop({ animated: "false" }, function (event) {});
            storage.setItem("TMBackHome", "true");
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    attrs: {
      "resize": "stretch",
      "src": "https://tt.ab-inbev.cn/TrackApp/AppUpdate/dtsappimages/404.png"
    }
  }), _c('text', {
    staticClass: ["textOne"]
  }, [_vm._v("很抱歉！系统繁忙")]), _c('text', {
    staticClass: ["textTwo"]
  }, [_vm._v("请稍后再来指派车辆")]), _c('text', {
    staticClass: ["button"],
    attrs: {
      "disabled": "true"
    },
