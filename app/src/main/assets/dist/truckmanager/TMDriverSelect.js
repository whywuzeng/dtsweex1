...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMDriverSelect.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6f63f86c"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        ...
        selectItem: function selectItem(item) {
            storage.setItem(_TMTruckConstants.tm_driver_selected, JSON.stringify(item), function (event) {});
        ...
        contentRefresh: function contentRefresh() {
            ...
            var sDriverText = this.inputBid == "" ? "anull" : this.inputBid;
            sDriverText = encodeURIComponent(sDriverText);
            // modal.toast({message:`${app_server_url}/TruckAssign/GetBillSelectDriver?UserID=${
            //             this.UserId}&sOrg_id=${this.sOrg_id}&sDriverText=${sDriverText}`});

            stream.fetch({
                method: "GET",
                url: app_server_url + "/TruckAssign/GetBillSelectDriver?UserID=" + this.UserId + "&sOrg_id=" + this.sOrg_id + "&sDriverText=" + sDriverText,
                type: "json"
            }, function (ret) {
                ...
                if (ret.ok === false) {
                    ...
                    _this.lists = ret.data.Data.SelectDriver;
                }
            });
        }
    },
    ...
    created: function created() {
        ...
        storage.getItem(_app_constants.app_userid, function (event) {
            if (event.result == "success") {
                ...
                storage.getItem("AppointmentAgentId", function (event) {
                    if (event.result == "success") {
                        _this2.sOrg_id = event.data;
