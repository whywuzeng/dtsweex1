...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMStateOrdersDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-98211962"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    name: "FMOrderDetails",
    components: { WxcButton: _weexUi.WxcButton, WxcMinibar: _weexUi.WxcMinibar, WxcLoading: _weexUi.WxcLoading, Utils: _weexUi.Utils, WxcCell: _weexUi.WxcCell },
    data: function data() {
        return {
            lists: {
                "ListA": [],
    ...
    methods: {
            ...
            if (this.entercount > 0) {
                ...
                storage.getItem(_TMTruckConstants.tm_truck_selected, function (event) {
                    if (event.result == "success") {
                        _this2.selectedTruck = JSON.parse(event.data);
                    }
                    if (JSON.stringify(_this2.selectedTruck) != "{}") {
                        _this2.isChangeInfo = true;
                    }
                });
                //
                storage.getItem(_TMTruckConstants.tm_driver_selected, function (event) {
                    if (event.result == "success") {
                        _this2.selectedDriver = JSON.parse(event.data);
                    }
                    if (JSON.stringify(_this2.selectedDriver) != "{}") {
                        _this2.isChangeInfo = true;
                    }
                });
                //
                storage.getItem("tm_gctruck_selected", function (event) {
                    if (event.result == "success") {
                        _this2.selectedgcTruck = JSON.parse(event.data);
                    }
                    if (JSON.stringify(_this2.selectedgcTruck) != "{}") {
                        _this2.isChangeInfo = true;
                    }
                });
            }
        ...
        getindexinfoHistory: function getindexinfoHistory() {
            ...
            stream.fetch({
                ...
                if (ret.ok === false) {
                    ...
                    _this3.billList = ret.data.Data.GetBillIndexHistory;
                    if (_this3.billList.length > 0) {
                        _this3.listFirstItem = _this3.billList[0];
                        _this3.IsComplete = _this3.listFirstItem.IsComplete;

                        _this3.CarrierCode = _this3.listFirstItem.CarrierCode;
                        storage.setItem("AppointmentAgentId", _this3.CarrierCode, function (event) {});
                    }
                }
            });
        },
        ...
        truckCellClicked: function truckCellClicked() {
            ...
            if (this.IsComplete == "Y") {
                //订单已完成
                modal.toast({ message: "订单已完成不能更换车辆!" });
                return;
            }
        ...
        wxChangeDriverClick: function wxChangeDriverClick() {
            ...
            modal.toast({ message: JSON.stringify(app_server_url + "TruckAssign/AssignBillChangeDriver?sBill_id=" + this.Bill_id + "&sDriver=" + this.selectedDriver.id + "&sTruckId=" + this.selectedTruck.id + "&sGtruckId=" + this.selectedgcTruck.id) });
        ...
        driverCellClicked: function driverCellClicked(e) {
            ...
            if (this.IsComplete == "Y") {
                //订单已完成
                modal.toast({ message: "订单已完成不能更换司机!" });
                return;
            }
        ...
        cancelAssign: function cancelAssign() {
            ...
            if (this.IsComplete == "Y") {
                //订单已完成
                modal.toast({ message: "订单已签收不能取消指派!" });
                return;
            }
    ...
    created: function created() {
        ...
        storage.getItem("TMHistoryOrdersBill_id", function (event) {
            ...
            _this4.BillId = event.data;

            _this4.Bill_id = event.data;
            ...
            stream.fetch({
                method: "GET",
                url: app_server_url + "Stack_Scheduling/GetDetailInfoAll?sBillId=" + _this4.BillId,
                type: "json"
            }, function (ret) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v("箱数：" + _vm._s(item.totPce) + "箱")]), _c('text', {
      staticClass: ["panel-text", "pOne"]
    ...
    slot: "value"
  }, [_vm._v(_vm._s(_vm.listFirstItem.GTruckNo))])])], 1), (_vm.lists.ListA.length == 0) ? _c('text', {
    staticStyle: {
      marginTop: "50px",
      textAlign: "center"
    }
  }, [_vm._v("没有数据")]) : _vm._e()], 2)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
