...
var _TMpagesConfig = __webpack_require__(233);
...
exports.default = {
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcButton: _weexUi.WxcButton, WxcIcon: _weexUi.WxcIcon, WxcPageCalendar: _weexUi.WxcPageCalendar, WxcTabPage: _weexUi.WxcTabPage, WxcLoading: _weexUi.WxcLoading, WxcPopup: _weexUi.WxcPopup },
    ...
    data: function data() {
        ...
        return _ref = {
            ...
            value: '',
            isTopShow: false
        }, _defineProperty(_ref, "startDate", ""), _defineProperty(_ref, "endDate", ""), _defineProperty(_ref, "sLoad", ""), _defineProperty(_ref, "sSend", ""), _defineProperty(_ref, "sBillid", ""), _defineProperty(_ref, "sAppointmentCode", ''), _ref;
    },
    ...
    methods: {
        ...
        jump: function jump(item) {
            ...
            storage.setItem('TMHistoryOrdersBill_id', item.Bill_id, function (event) {});
            storage.getItem("app_bundle_url", function (event) {
                if (event.data === undefined || event.data === null) {
                    return;
                }
                navigator.push({
                    url: event.data + "truckmanager/TMHistoryOrderDetail.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        contentRefresh: function contentRefresh() {
            ...
            var myLoad = this.sLoad == "" ? "anull" : this.sLoad; //装货点
            var mySend = this.sSend == "" ? "anull" : this.sSend; //卸货点
            var myBillid = this.sBillid == "" ? "anull" : this.sBillid; //负载单号
            var myAppointmentCode = this.sAppointmentCode == "" ? "anull" : this.sAppointmentCode; //负载单号

            myLoad = encodeURIComponent(myLoad);
            mySend = encodeURIComponent(mySend);
            myBillid = encodeURIComponent(myBillid);
            myAppointmentCode = encodeURIComponent(myAppointmentCode);

            // modal.toast({message:`${app_server_url}TruckAssign/GetAssignBillListHistoryTest?serviceCode=${this.serviceCode}&UserID=${this.UserId}&sStarDate=${this.startDate}&sEndDate=${this.endDate}&sBillid=${myBillid}&sLoad=${myLoad}&sSend=${mySend}`});
            stream.fetch({
                method: "GET",
                url: app_server_url + "TruckAssign/GetAssignBillListHistoryTest?serviceCode=" + this.serviceCode + "&UserID=" + this.UserId + "&sStarDate=" + this.startDate + "&sEndDate=" + this.endDate + "&sBillid=" + myBillid + "&sLoad=" + myLoad + "&sSend=" + mySend + "&sAppointmentCode=" + myAppointmentCode,
                type: "json"
            }, function (ret) {
                _this3.isShowLoadding = false;
                ...
                if (ret.ok === false) {
                    ...
                    _this3.lists = ret.data.Data.result;
                }
            });
        },
        http: function http() {
            ...
            storage.getItem(_app_constants.app_userid, function (event) {
                if (event.result == "success") {
                    _this4.UserId = event.data;

                    _this4.contentRefresh();
                }
            });
        }
    },
    ...
    created: function created() {
        ...
        if (this.isipx) {
            ...
            //modal.toast({ message:  'ipx'  });
            this.scrollHeight = bodyHeight - 446;
        } else if (this.isiphone) {
            //modal.toast({ message:  'iphone'  });
            this.scrollHeight = bodyHeight - 340;
        } else {
            this.scrollHeight = bodyHeight - 340;
        }
        ...
        // modal.toast({message:year+'-'+month+'-'+day});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      style: {
        height: (_vm.tabPageHeight - _vm.tabStyles.height - 40 - 90 - 120) + 'px'
      }
    }, [_c('list', {
      staticClass: ["list"],
      style: {
      ...
      }, [_vm._v(_vm._s(item.handeTime))]), _c('text', {
        staticClass: ["iconfont", "cell-shop-icon"]
      }, [_vm._v("")]), _c('text', {
        staticClass: ["shop"]
      }, [_vm._v(_vm._s(item.toShpgLocName))]), _c('text', {
        staticClass: ["iconfont", "cell-address-icon"]
      }, [_vm._v("")]), _c('text', {
        staticClass: ["address"]
      }, [_vm._v(_vm._s(item.destinationName))]), _c('div', {
        staticClass: ["cell-bottom"]
      }, [_c('text', {
        staticClass: ["cell-license-number"]
      }, [_vm._v(_vm._s(item.TmsCount) + "张订单:" + _vm._s(item.CodeList))]), _c('text', {
        staticClass: ["iconfont", "cell-arrow"]
      }, [_vm._v("")])])])])
    ...
    attrs: {
      "type": "text",
      "placeholder": "请输入来源地名称或ID",
      "value": (_vm.sLoad)
    },
    on: {
      "input": function($event) {
        _vm.sLoad = $event.target.attr.value
      }
    }
  })]), _c('div', {
    staticClass: ["filter-cell"]
    ...
    attrs: {
      "type": "text",
      "placeholder": "请输入目的地名称或ID",
      "value": (_vm.sSend)
    },
    on: {
      "input": function($event) {
        _vm.sSend = $event.target.attr.value
      }
    }
  })]), _c('div', {
    staticClass: ["filter-cell"]
    ...
    on: {
      "input": function($event) {
        _vm.sBillid = $event.target.attr.value
      }
    }
  })]), _c('div', {
    staticClass: ["filter-cell"]
    ...
    staticClass: ["title-text"]
  }, [_vm._v("负载单号:")]), _c('input', {
    staticClass: ["z-input"],
    attrs: {
      "type": "text",
      "placeholder": "请输入负载单号",
      "value": (_vm.sAppointmentCode)
    },
    on: {
      "input": function($event) {
        _vm.sAppointmentCode = $event.target.attr.value
      }
    }
  })]), _c('div', {
    staticClass: ["popup-btn"]
  }, [_c('text', {
    staticClass: ["popup-btn-cancel"],
    on: {
      "click": _vm.btnCancel
    }
  }, [_vm._v("取消")]), _c('text', {
    staticClass: ["popup-btn-put"],
    on: {
      "click": _vm.btnPut
    }
  }, [_vm._v("确定")])])])], 1)
...
exports.default = {
    name: "TMOrdersAllocation",
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcLoading: _weexUi.WxcLoading, WxcTabPage: _weexUi.WxcTabPage, WxcDialog: _weexUi.WxcDialog, WxcPopup: _weexUi.WxcPopup },
    data: function data() {
        return {
            isShowLoadding: true,
            tabTitles: _TMpagesConfig2.default.tabTitles,
    ...
    methods: {
        ...
        wxcTabPageCurrentTabSelected: function wxcTabPageCurrentTabSelected(e) {
            ...
            storage.setItem("TMOrdersAllocationCurrentServiceCode", this.serviceCode, function (event) {});

            this.startDate = this.sBeforeDate;
            this.endDate = this.sAfterDate;
            this.sLoad = ""; //装货点
            this.sSend = ""; //卸货点
            this.sBillid = ""; //负载单号

            this.agentIndexArray = [0], this.getAgentList();
        },
        ...
        wxcDialogCancelBtnClicked: function wxcDialogCancelBtnClicked() {
            ...
            this.agentList.forEach(function (val, index, array) {
                val.checked = false;
            });

            this.agentIndexArray.forEach(function (val, index, array) {
                _this3.agentList[val].checked = true;
            });
        },
        wxcDialogNoPromptClicked: function wxcDialogNoPromptClicked(e) {
            //此处必须设置，组件为无状态组件，自己管理
            this.isCheckedAgent = e.isChecked;
        },
        ...
        wxcDialogConfirmBtnClicked: function wxcDialogConfirmBtnClicked() {
            ...
            this.agentIndexArray.splice(0, this.agentIndexArray.length);

            this.agentList.forEach(function (val, index, array) {
                if (val.checked) {
                    _this4.agentIndexArray.push(index);
                }
            });

            if (this.agentIndexArray.length == 0) {
                modal.toast({ message: "至少选择一个承运商!" });
                return;
            }

            var selectedAgentIndex = this.agentIndexArray[0];
            this.selectedAgent = this.agentList[selectedAgentIndex].text;

            this.selectedAgentId = "";
            this.agentIndexArray.forEach(function (val, index, array) {

                if (_this4.selectedAgentId.length == 0) {
                    _this4.selectedAgentId = _this4.agentList[val].id;
                } else {
                    _this4.selectedAgentId = _this4.selectedAgentId + "," + _this4.agentList[val].id;
                }
            });

            storage.setItem("AppointmentAgentId", this.selectedAgentId, function (event) {});
            this.contentRefresh();
        },

        // 选择承运商
        dialogSelection: function dialogSelection(item, index) {

            this.isCheckedAgent = false;

            item.checked = !item.checked;

            this.isCheckedAgent = undefined;
        },
        ...
        //合并指派
        headerButtonClick: function headerButtonClick(e) {

            storage.setItem("TMOrdersAllocationBillList", JSON.stringify(this.lists), function (event) {});
            storage.setItem("TMOrdersAllocationBillListURL", this.sURL, function (event) {});
            ...
            storage.getItem(_app_constants.app_bundle_url, function (event) {
                ...
                navigator.push({
                    url: event.data + "truckmanager/TMMultiOrdersAllocation.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        //指派车辆
        cellButtonClicked: function cellButtonClicked(item) {
            storage.setItem("AppointmentCodes", item.AppointmentCode, function (event) {});
            ...
            storage.getItem(_app_constants.app_bundle_url, function (event) {
                ...
                navigator.push({
                    url: event.data + "truckmanager/TMTruckAssign.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        contentRefresh: function contentRefresh() {
            ...
            // modal.toast({message:"列表----" + `${app_server_url}TruckAssign/GetBillListTest?serviceCode=${this.serviceCode}&UserID=${this.UserId}&sOrg_id=${this.selectedAgentId}&sStarDate=${this.startDate}&sEndDate=${this.endDate}&sBillid=${myBillid}&sLoad=${myLoad}&sSend=${mySend}`});
            this.sURL = app_server_url + "TruckAssign/GetBillListTest?serviceCode=" + this.serviceCode + "&UserID=" + this.UserId + "&sOrg_id=" + this.selectedAgentId + "&sStarDate=" + this.startDate + "&sEndDate=" + this.endDate + "&sBillid=" + myBillid + "&sLoad=" + myLoad + "&sSend=" + mySend;

            stream.fetch({
                method: "GET",
                url: app_server_url + "TruckAssign/GetBillListTest?serviceCode=" + this.serviceCode + "&UserID=" + this.UserId + "&sOrg_id=" + this.selectedAgentId + "&sStarDate=" + this.startDate + "&sEndDate=" + this.endDate + "&sBillid=" + myBillid + "&sLoad=" + myLoad + "&sSend=" + mySend,
                type: "json"
            }, function (ret) {
                _this5.isShowLoadding = false;

                if (ret.ok === false) {
                    modal.toast({ message: "网络访问失败-列表", duration: 0.3 });
                } else if (ret.data.Result !== "True") {
                    modal.toast({ message: ret.data.Info });
                } else {
                    //GetBillList
                    _this5.lists = ret.data.Data.GetBillListTest;
                }
            });
        },
        ...
        getAgentList: function getAgentList() {
            ...
            this.isShowLoadding = true;
            // modal.toast({message:"承运商----" +`${app_server_url}TruckAssign/GetApp_AssignCysJxsSelect?serviceCode=${this.serviceCode}&UserID=${this.UserId}`});
            stream.fetch({
                method: "GET",
                url: app_server_url + "TruckAssign/GetApp_AssignCysJxsSelect?serviceCode=" + this.serviceCode + "&UserID=" + this.UserId,
                type: "json"
            }, function (ret) {

                if (ret.ok === false) {
                    modal.toast({ message: "网络访问失败-承运商", duration: 0.3 });
                } else if (ret.data.Result !== "True") {
                    modal.toast({ message: ret.data.Info });
                } else {

                    var array = ret.data.Data.CysJxsSelect;

                    if (ret.data.Data.CysJxsSelect.length == 0) {
                        _this6.isShowLoadding = false;
                        return;
                    }

                    ret.data.Data.CysJxsSelect.forEach(function (val, index, array) {
                        val.checked = false;
                    });
                    _this6.agentIndexArray.forEach(function (val, index, array) {
                        ret.data.Data.CysJxsSelect[val].checked = true;
                    });

                    _this6.agentList = ret.data.Data.CysJxsSelect;

                    var selectedAgentIndex = _this6.agentIndexArray[0];
                    _this6.selectedAgent = _this6.agentList[selectedAgentIndex].text;

                    //拼接selectedAgentId
                    _this6.selectedAgentId = "";
                    _this6.agentIndexArray.forEach(function (val, index, array) {

                        if (_this6.selectedAgentId.length == 0) {
                            _this6.selectedAgentId = _this6.agentList[val].id;
                        } else {
                            _this6.selectedAgentId = _this6.selectedAgentId + "," + _this6.agentList[val].id;
                        }
                    });

                    storage.setItem("AppointmentAgentId", _this6.selectedAgentId, function (event) {});

                    _this6.contentRefresh();
                }
            });
        },
        http: function http() {
            ...
            storage.setItem("TMBackHome", "false");

            storage.getItem(_app_constants.app_userid, function (event) {
                if (event.result == "success") {
                    _this7.UserId = event.data;
        ...
        //获取当前日期的前三天
        getBeforeDate: function getBeforeDate() {
            //获取当前日期
            var date = new Date();
    ...
    created: function created() {
        ...
        if (this.isipx) {
            ...
            this.scrollHeight = bodyHeight - 520 - 106;
        } else if (this.isiphone) {

            this.scrollHeight = bodyHeight - 520;
        } else {
            this.scrollHeight = bodyHeight - 520;
        }
        ...
        storage.setItem("TMOrdersAllocationCurrentServiceCode", "D1", function (event) {});
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["dialog-content-scroller"]
  }, _vm._l((_vm.agentList), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: ["dialog-content-list"],
      on: {
        "click": function($event) {
          _vm.dialogSelection(item, index)
        }
      }
    }, [(item.checked) ? _c('text', {
      staticClass: ["iconfont", "dialog-content-icon", "themeColor"]
    }, [_vm._v("")]) : _c('text', {
    ...
    }, [_vm._v(_vm._s(_vm.selectedAgent ? _vm.selectedAgent : "选择承运商") + "  已选" + _vm._s(_vm.agentIndexArray.length) + "家")]), _c('text', {
      staticClass: ["iconfont", "select-icon"]
    }, [_vm._v("")]), _c('text', {
      staticClass: ["iconfont", "select-filter"],
      staticStyle: {
        marginLeft: "10px"
      },
      on: {
    ...
    }, [_vm._v("")])]), (_vm.lists.length > 0 && (_vm.tabTitles[index].serviceCode === 'D1' || _vm.tabTitles[index].serviceCode === 'D3' || _vm.tabTitles[index].serviceCode === 'D4')) ? _c('div', {
      staticClass: ["header-button"],
      on: {
        "click": _vm.headerButtonClick
      }
    }, [_c('text', {
      staticClass: ["iconfont", "header-icon"]
    }, [_vm._v("")]), _c('text', {
      staticClass: ["header-text"]
    }, [_vm._v("合并指派")])]) : _vm._e(), _c('list', [_vm._l((_vm.lists), function(item, indexc) {
      return _c('cell', {
        key: indexc,
        staticClass: ["cell"],
        appendAsTree: true,
        ...
        staticClass: ["KAOrder"]
      }, [_vm._v("负载单号:" + _vm._s(item.AppointmentCode))]), _c('text', {
        staticClass: ["cell-time-text"]
      }, [_vm._v(_vm._s(item.handeTime))]), _c('text', {
        staticClass: ["iconfont", "cell-shop-icon"]
      }, [_vm._v("")]), _c('text', {
        staticClass: ["shop"]
        ...
        staticClass: ["cell-address-text"]
      }, [_vm._v(_vm._s(item.destinationName))]), _c('text', {
        staticClass: ["cell-buttonstyle"],
        on: {
          "click": function($event) {
            _vm.cellButtonClicked(item)
          }
        }
      }, [_vm._v("指派车辆")])])])
    }), (_vm.lists.length == 0) ? _c('cell', {
...
module.exports = {
  ...
  "cell-left-highlighted": {
    "width": "200",
    "backgroundColor": "rgb(56,113,178)"
  },
  "cell-right": {
    "width": "510",
    "backgroundColor": "#ffffff",
...
exports.default = {
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcIcon: _weexUi.WxcIcon, Utils: _weexUi.Utils, WxcLoading: _weexUi.WxcLoading },
    name: "TMTruckState",
    ...
    methods: {
        ...
        //
        jump: function jump(item) {
            if (item.TruckStatus != "空闲") {
                storage.setItem("TMHistoryOrdersTruckid", item.Truckid, function (event) {});
                storage.getItem("app_bundle_url", function (event) {
                    if (event.data === undefined || event.data === null) {
                        return;
                    }
                    navigator.push({
                        url: event.data + "truckmanager/TMTruckStateDetail.js",
                        animated: "true"
                    }, function (event) {});
                });
            }
        ...
        contentRefresh: function contentRefresh() {
            ...
            var sTruckText = this.inputBid == "" ? "anull" : this.inputBid;
            sTruckText = encodeURIComponent(sTruckText);

            stream.fetch({
                method: "GET",
                url: app_server_url + "TruckAssign/GetAssignTruckStatus?UserID=" + this.UserId + "&sTruckText=" + sTruckText,
                type: "json"
            }, function (ret) {
                _this.isShowLoadding = false;
                ...
                if (ret.ok === false) {
                    ...
                    _this.list = ret.data.Data.TruckStatusList;
                }
            });
        },
        http: function http() {
    ...
    created: function created() {
        ...
        // modal.toast({ message:"bodyHeight:" + bodyHeight  });
        if (this.isipx) {

            this.scrollHeight = bodyHeight - 356 - 120;
        } else if (this.isiphone) {

            this.scrollHeight = bodyHeight - 250 - 120;
        } else {
            this.scrollHeight = bodyHeight - 250 - 50 - 120;
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["select-text", "iconfont"]
  }, [_vm._v("")]), _c('input', {
    staticClass: ["bidtext"],
    attrs: {
      "type": "text",
    ...
    }, [(item.TruckStatus != '空闲') ? _c('div', {
      staticClass: ["cell-left-highlighted"]
    }, [_c('text', {
      staticClass: ["cell-left-text"]
    }, [_vm._v(_vm._s(item.TruckNo))])]) : _c('div', {
      staticClass: ["cell-left-gray"]
    }, [_c('text', {
      staticClass: ["cell-left-text"]
    }, [_vm._v(_vm._s(item.TruckNo))])]), _c('div', {
      staticClass: ["cell-right"]
    }, [_c('text', {
      staticClass: ["cell-right-type"]
    }, [_vm._v("车型:" + _vm._s(item.TruckType))]), (item.TruckStatus === '空闲') ? _c('text', {
      staticClass: ["cell-right-status", "status-isfree"]
    }, [_vm._v("空闲")]) : _c('text', {
      staticClass: ["cell-right-status"]
    }, [_vm._v(_vm._s(item.TruckStatus))]), _c('text', {
      staticClass: ["cell-right-belong"]
    }, [_vm._v("车长:" + _vm._s(item.TruckLength))])])])
  }), (_vm.list.length == 0) ? _c('div', {
    staticClass: ["nodata-cell"]
  }, [_c('text', {
    staticClass: ["nodata-text"]
  }, [_vm._v("暂时无相关数据哦!")])]) : _vm._e()], 2)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMTabs.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-dcb5d8b4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _TMTabsConfig = __webpack_require__(444);

var _TMTabsConfig2 = _interopRequireDefault(_TMTabsConfig);

var _TMOrdersAllocation = __webpack_require__(445);

var _TMOrdersAllocation2 = _interopRequireDefault(_TMOrdersAllocation);

var _TMHistoryOrders = __webpack_require__(446);

var _TMHistoryOrders2 = _interopRequireDefault(_TMHistoryOrders);

var _TMTruckState = __webpack_require__(447);

var _TMTruckState2 = _interopRequireDefault(_TMTruckState);
...
exports.default = {
  name: 'TMTabs',
  components: { WxcTabBar: _weexUi.WxcTabBar, TMOrdersAllocation: _TMOrdersAllocation2.default, TMHistoryOrders: _TMHistoryOrders2.default, TMMy: _TMMy2.default, TMTruckState: _TMTruckState2.default },
  data: function data() {
    return {
      tabTitles: _TMTabsConfig2.default.tabTitles,
      tabStyles: _TMTabsConfig2.default.tabStyles,
      enterCount: 0,
      pageIndex: 0
    };
  },
  ...
  methods: {
    ...
    onappear: function onappear() {
      ...
      // modal.toast({ message: "-- onappear -- enterCount:" + this.enterCount  });

      if (this.enterCount > 0 && this.pageIndex == 0) {
        this.$refs.TMOrdersAllocation.http();
        this.$refs.TMHistoryOrders.contentRefresh();
        return;
      } else if (this.enterCount > 0 && this.pageIndex == 1) {
        this.$refs.TMOrdersAllocation.http();
        this.$refs.TMHistoryOrders.contentRefresh();
        return;
      } else if (this.enterCount === 0) {
        this.$refs.TMOrdersAllocation.http();
        this.$refs.TMHistoryOrders.http();
        this.$refs.TMTruckState.http();
      }
    },
...
exports.default = {
  ...
  tabTitles: [{
    title: '订单分配',
    icon: _app_constants.app_images_url + 'order_assign.png', //'https://gw.alicdn.com/tfs/TB1MWXdSpXXXXcmXXXXXXXXXXXX-72-72.png',
    activeIcon: _app_constants.app_images_url + 'order_assign_sel.png' //'https://gw.alicdn.com/tfs/TB1kCk2SXXXXXXFXFXXXXXXXXXX-72-72.png'
  }, {
    title: '历史订单',
    ...
    title: '车辆状态',
    icon: _app_constants.app_images_url + 'track_status.png', //'https://gw.alicdn.com/tfs/TB1VKMISXXXXXbyaXXXXXXXXXXX-72-72.png',
    activeIcon: _app_constants.app_images_url + 'track_status_sel.png' //'https://gw.alicdn.com/tfs/TB1aTgZSXXXXXazXFXXXXXXXXXX-72-72.png',
  }, {
    title: '我的',
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMOrdersAllocation.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-64c2124d"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMHistoryOrders.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-79013821"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMTruckState.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-006f959a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["item-container"],
    style: _vm.contentStyle
  }, [_c('TMOrdersAllocation', {
    ref: "TMOrdersAllocation"
  })], 1), _c('div', {
    staticClass: ["item-container"],
    style: _vm.contentStyle
  }, [_c('TMHistoryOrders', {
