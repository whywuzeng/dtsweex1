...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/ChangeEnvironment.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-9fe14c38"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    //正式
    officialCellClicked: function officialCellClicked() {

      storage.setItem('app_server_url', 'https://tt.ab-inbev.cn/TrackApp/');
      storage.setItem('app_server_enviroment', "pro_");
      (0, _DTSPlugins.YtChangeServer)({ toTestServer: "false" }, function (err, ret) {});
    ...
    //测试
    testCellClicked: function testCellClicked() {

      storage.setItem('app_server_url', 'http://40.73.115.31/DTSApi/');
      storage.setItem('app_server_enviroment', "dev_");
      (0, _DTSPlugins.YtChangeServer)({ toTestServer: "true" }, function (err, ret) {});
    ...
    //内部测试
    testtextCellClicked: function testtextCellClicked() {
      storage.setItem('app_server_url', 'http://40.73.103.221/TrackApp/');
      storage.setItem('app_server_enviroment', "dev_");
      (0, _DTSPlugins.YtChangeServer)({ toTestServer: "true" }, function (err, ret) {});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcCellClicked": _vm.officialCellClicked
    }
  }, [_c('text', {
    ...
    slot: "value"
  }, [_vm._v("https://tt.ab-inbev.cn/TrackApp/")])]), _c('wxc-cell', {
    attrs: {
      "title": "测试",
      "hasArrow": false,
      "hasTopBorder": false
    ...
    on: {
      "wxcCellClicked": _vm.testCellClicked
    }
  }, [_c('text', {
    staticClass: ["cell-placeholder"],
    attrs: {
    ...
    slot: "value"
  }, [_vm._v("http://40.73.115.31/DTSApi/")])]), _c('wxc-cell', {
    attrs: {
      "title": "内部*测试",
      "hasArrow": false,
      "hasTopBorder": false
    ...
    on: {
      "wxcCellClicked": _vm.testtextCellClicked
    }
  }, [_c('text', {
    staticClass: ["cell-placeholder"],
    attrs: {
    ...
    slot: "value"
  }, [_vm._v("http://40.73.103.221/TrackApp/")])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
