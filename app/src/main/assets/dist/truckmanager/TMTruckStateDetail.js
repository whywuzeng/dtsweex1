...
/* styles */
__vue_styles__.push(__webpack_require__(460)
)
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMTruckStateDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-27ab300b"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcButton: _weexUi.WxcButton, WxcIcon: _weexUi.WxcIcon, WxcLoading: _weexUi.WxcLoading },
    ...
    methods: {
        jump: function jump(item) {
            ...
            storage.getItem("app_bundle_url", function (event) {
                ...
                navigator.push({
                    url: event.data + "truckmanager/TMStateOrdersDetail.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        contentRefresh: function contentRefresh() {
            ...
            stream.fetch({
                method: "GET",
                url: app_server_url + "TruckAssign/GetAssignTruckStatusDetail?TruckId=" + this.truckId,
                type: "json"
            }, function (ret) {
    ...
    created: function created() {
        ...
        storage.getItem("TMHistoryOrdersTruckid", function (event) {
            if (event.result == "success") {
                _this2.truckId = event.data;
