...
//选择车辆反向传值key
var tm_truck_selected = exports.tm_truck_selected = 'tm_truck_selected';

//选择司机反向传值key
var tm_driver_selected = exports.tm_driver_selected = 'tm_driver_selected';
...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMHistoryOrderDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-38b2649a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports = {
  ...
  "cell-placeholder-first": {
    "color": "#c00000",
    "fontSize": "28",
    "fontWeight": "bold",
    "paddingRight": "25"
  },
  "cell-placeholder-second": {
    "color": "#666666",
    "fontSize": "28",
    "fontWeight": "bold"
  },
  "cell-placeholder-third": {
    "color": "#666666",
    "fontSize": "28",
    "fontWeight": "bold"
  },
...
var _TMTruckConstants = __webpack_require__(232);
...
exports.default = {
    name: "FMOrderDetails",
    components: { WxcButton: _weexUi.WxcButton, WxcMinibar: _weexUi.WxcMinibar, WxcLoading: _weexUi.WxcLoading, Utils: _weexUi.Utils, WxcCell: _weexUi.WxcCell, WxcDialog: _weexUi.WxcDialog },
    data: function data() {
        return {
            lists: {
                "ListA": [],
    ...
    methods: {
        //更换司机-取消
        changeTruckDialogCancelBtnClicked: function changeTruckDialogCancelBtnClicked() {
            this.changeEscshow = false;
        },

        //更换司机-确定
        changeTruckDialogConfirmBtnClick: function changeTruckDialogConfirmBtnClick() {
            var _this2 = this;

            this.changeEscshow = false;

            if (JSON.stringify(this.selectedDriver) == "{}") {
                this.selectedDriver.text = this.listFirstItem.DriverName;
                this.selectedDriver.id = this.listFirstItem.DriverID;
            }
            if (JSON.stringify(this.selectedTruck) == "{}") {
                this.selectedTruck.text = this.listFirstItem.TruckNo;
                this.selectedTruck.id = this.listFirstItem.TruckId;
            }

            this.listFirstItem.GTruckNo = this.listFirstItem.GTruckNo == "" ? "anull" : this.listFirstItem.GTruckNo;
            if (JSON.stringify(this.selectedgcTruck) == "{}") {
                this.selectedgcTruck.text = this.listFirstItem.GTruckNo == "" ? "anull" : this.listFirstItem.GTruckNo;
                this.selectedgcTruck.id = this.listFirstItem.GTruckID == "" ? "anull" : this.listFirstItem.GTruckID;
            }

            // modal.toast({message:JSON.stringify(`${app_server_url}TruckAssign/AssignBillChangeDriver?sBill_id=${
            //             this.Bill_id
            //         }&sDriver=${this.selectedDriver.id}&sTruckId=${this.selectedTruck.id}&sGtruckId=${this.selectedgcTruck.id}`)}); 

            this.isShowLoadding = true;
            stream.fetch({
                method: "POST",
                url: app_server_url + "TruckAssign/AssignBillChangeDriver?sBill_id=" + this.Bill_id + "&sDriver=" + this.selectedDriver.id + "&sTruckId=" + this.selectedTruck.id + "&sGtruckId=" + this.selectedgcTruck.id,
                type: "json"
            }, function (ret) {
                ...
                if (ret.ok === false) {
                    ...
                    modal.toast({ message: ret.data.Data.result[0].text });

                    var result = ret.data.Data.result[0];
                    if (result.id === "-1") {
                        //更换司机失败
                        return;
                    }
        ...
        tmdialogConfirmBtnClick: function tmdialogConfirmBtnClick() {
            ...
            stream.fetch({
                method: "POST",
                url: app_server_url + "TruckAssign/AssignCancel?sBill_id=" + this.Bill_id,
                type: "json"
            }, function (ret) {
                ...
                if (ret.ok === false) {
                    ...
                    modal.toast({ message: result.text });
                    if (result.id === "-1") {
                        //取消指派失败
                        return;
                    }
        ...
        viewappear: function viewappear() {
            ...
            if (this.entercount > 0) {
                //
                storage.getItem(_TMTruckConstants.tm_truck_selected, function (event) {
                    if (event.result == "success") {
                        _this4.selectedTruck = JSON.parse(event.data);
                    }
                    if (JSON.stringify(_this4.selectedTruck) != "{}") {
                        _this4.isChangeInfo = true;
                    }
                });
                //
                storage.getItem(_TMTruckConstants.tm_driver_selected, function (event) {
                    if (event.result == "success") {
                        _this4.selectedDriver = JSON.parse(event.data);
                    }
                    if (JSON.stringify(_this4.selectedDriver) != "{}") {
                        _this4.isChangeInfo = true;
                    }
                });
                //
                storage.getItem("tm_gctruck_selected", function (event) {
                    if (event.result == "success") {
                        _this4.selectedgcTruck = JSON.parse(event.data);
                    }
                    if (JSON.stringify(_this4.selectedgcTruck) != "{}") {
                        _this4.isChangeInfo = true;
                    }
                });
            }
        ...
        getImg: function getImg() {
            var _this = this;
            (0, _DTSPlugins.YtQRGenerator)({
                codeValue: _this.BillId, //必填
                isQRCode: "false", //选填 false:条形码 true:二维码
                width: "600", //选填
                height: "114" //选填
            }, function (err, ret) {
                if (err === null || err === undefined) {
                    //  modal.toast({ message: ret.path });
        ...
        //订单详情
        getindexinfoHistory: function getindexinfoHistory() {
            var _this5 = this;
            ...
            stream.fetch({
                method: "GET",
                url: app_server_url + "TruckAssign/GetindexinfoHistory?sBill_id=" + this.Bill_id,
                type: "json"
            }, function (ret) {
                ...
                if (ret.ok === false) {
                    ...
                    _this5.billList = ret.data.Data.GetBillIndexHistory;
                    if (_this5.billList.length > 0) {
                        _this5.listFirstItem = _this5.billList[0];

                        _this5.CTruck = _this5.listFirstItem.CTruck;
                        _this5.Cdrvier = _this5.listFirstItem.Cdrvier;
                        _this5.CAssign = _this5.listFirstItem.CAssign;

                        _this5.CarrierCode = _this5.listFirstItem.CarrierCode;
                        storage.setItem("AppointmentAgentId", _this5.CarrierCode, function (event) {});
                    }
                }
            });
        },
        ...
        //选择车辆
        truckCellClicked: function truckCellClicked() {

            if (this.CTruck == "N") {
                modal.toast({ message: "不能更换车辆!" });
                return;
            }
            ...
            storage.getItem(_app_constants.app_bundle_url, function (event) {
                ...
                navigator.push({
                    url: event.data + "truckmanager/TMTruckSelect.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        //选择挂车
        gcTruckCellClicked: function gcTruckCellClicked() {

            modal.toast({ message: "不能更换挂车!" });
            return;
            ...
            storage.getItem(_app_constants.app_bundle_url, function (event) {
                ...
                navigator.push({
                    url: event.data + "truckmanager/TMgcTruckSelect.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        //更换司机/车辆
        wxChangeDriverClick: function wxChangeDriverClick() {
            if (this.Bill_id === "") {
                return;
            }

            if (this.Cdrvier == "N" && this.CTruck == "N") {
                modal.toast({ message: "不能更换司机、车辆!" });
                return;
            }
            if (JSON.stringify(this.selectedDriver) == "{}" && JSON.stringify(this.selectedTruck) == "{}" && JSON.stringify(this.selectedgcTruck) == "{}") {
                modal.toast({ message: "请选择司机、车辆!" });
                return;
            }

            this.changeEscshow = true;
        },

        //选择司机
        driverCellClicked: function driverCellClicked(e) {

            if (this.Cdrvier == "N") {
                modal.toast({ message: "不能更换司机!" });
                return;
            }
            ...
            storage.getItem(_app_constants.app_bundle_url, function (event) {
                ...
                navigator.push({
                    url: event.data + "truckmanager/TMDriverSelect.js",
                    animated: "true"
                }, function (event) {});
            });
        },
        ...
        cancelAssign: function cancelAssign() {
            ...
            if (this.CAssign == "N") {
                modal.toast({ message: "不能取消指派!" });
            } else if (this.CAssign == "Y") {
                this.Escshow = true;
            }
        }
    },
    ...
    created: function created() {
        ...
        storage.removeItem(_TMTruckConstants.tm_driver_selected, function (event) {});
        storage.removeItem(_TMTruckConstants.tm_truck_selected, function (event) {});
        storage.removeItem("tm_gctruck_selected", function (event) {});

        storage.getItem("TMHistoryOrdersBill_id", function (event) {
            if (event.data === undefined || event.data === null) {
                return;
            }
            _this6.BillId = event.data;

            _this6.Bill_id = event.data;

            //订单详情
            _this.getindexinfoHistory();

            _this.getImg();

            stream.fetch({
                method: "GET",
                url: app_server_url + "Stack_Scheduling/GetDetailInfoAll?sBillId=" + _this6.BillId,
                type: "json"
            }, function (ret) {
                ...
                if (ret.ok === false) {
                    ...
                    ret.data.Data.result.ListB.forEach(function (val) {
                        val.checked = false;
                    });

                    ret.data.Data.result.ListC.forEach(function (val) {
                        val.checked = false;
                    });

                    _this.lists = ret.data.Data.result;
                }
            });
        });
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._l((_vm.lists.ListA), function(item) {
    return (_vm.lists.ListA.length != 0) ? _c('div', {
      key: item,
      staticClass: ["ddDetail-top"]
    }, [_c('div', {
      staticClass: ["top-line"]
    }, [_c('text', {
      staticClass: ["top-text", "color999"]
    }, [_vm._v("调度单号：")]), _c('text', {
      staticClass: ["top-text"]
    }, [_vm._v(_vm._s(item.Bill_id))])]), _c('div', {
      staticClass: ["top-line"]
    }, [_c('text', {
      staticClass: ["top-text", "color999"]
    }, [_vm._v("负载单号：")]), _c('text', {
      staticClass: ["top-text"]
    }, [_vm._v(_vm._s(item.CodeList))])]), _c('div', {
      staticClass: ["top-line"]
    }, [_c('text', {
      staticClass: ["top-text", "color999"]
    }, [_vm._v("请求交货日期：")]), _c('text', {
      staticClass: ["top-text"]
    }, [_vm._v(_vm._s(item.frmPkupDtt))])]), _c('div', {
      staticClass: ["top-line"]
    }, [_c('text', {
      staticClass: ["top-text", "color999"]
    }, [_vm._v("车辆信息：")]), _c('text', {
      staticClass: ["top-text"]
    }, [_vm._v(_vm._s(item.TruckInfo))])]), _c('div', {
      staticClass: ["top-line"]
    }, [_c('text', {
      staticClass: ["top-text", "color999"]
    }, [_vm._v("路线：")]), _c('text', {
      staticClass: ["top-text"]
    }, [_vm._v(_vm._s(item.rateCode))])]), _c('div', {
      staticClass: ["top-line"]
    }, [_c('text', {
      staticClass: ["top-text", "color999"]
    }, [_vm._v("承运商：")]), _c('text', {
      ...
      staticClass: ["top-text"]
    }, [_vm._v(_vm._s(item.DriverInfo))])]), _c('div', {
      staticClass: ["top-line"]
    }, [_c('text', {
      staticClass: ["top-text", "color999"]
    }, [_vm._v("商品编码：")]), _c('text', {
      staticClass: ["top-text"]
    }, [_vm._v(_vm._s(item.CommodityCode))])]), _c('image', {
      staticClass: ["div-img"],
      attrs: {
        "resize": "stretch",
        "src": _vm.imgurl
    ...
    staticClass: ["ddDetail-body"]
  }, [_c('div', {
    staticClass: ["listBody"]
  }, [_vm._l((_vm.lists.ListB), function(item) {
    return _c('div', {
      key: item,
      staticClass: ["cellBody"]
    }, [_c('div', {
      staticClass: ["panelTop"],
      on: {
        "click": function($event) {
          _vm.shrink(item)
        }
      ...
      staticClass: ["panel-title", "color999"]
    }, [_vm._v("停靠点代码")]), _c('text', {
      staticClass: ["panel-title", "paddingR70"]
    }, [_vm._v(_vm._s(item.LocationCode))]), (item.checked) ? _c('text', {
      staticClass: ["iconfont", "posArrow"]
    }, [_vm._v("")]) : _c('text', {
      staticClass: ["iconfont", "posArrow"]
    ...
    }, [_vm._v(_vm._s(item.StopName))]), _c('text', {
      staticClass: ["panel-text"]
    }, [_vm._v(_vm._s(item.StopAddress))]), _c('text', {
      staticClass: ["panel-text"]
    }, [_vm._v("预约时间：" + _vm._s(item.Cmtd_start_dtt))]), _c('text', {
      staticClass: ["panel-text"]
    }, [_vm._v("运输类型:" + _vm._s(item.PDName))])]) : _vm._e()])
  }), _vm._l((_vm.lists.ListC), function(item) {
    return _c('div', {
      key: item,
      staticClass: ["cellBody"]
    }, [_c('div', {
      ...
      staticClass: ["panel-title", "paddingR70"]
    }, [_vm._v(_vm._s(item.ShipmentId))]), (item.checked) ? _c('text', {
      staticClass: ["iconfont", "posArrow"]
    }, [_vm._v("")]) : _c('text', {
      staticClass: ["iconfont", "posArrow"]
    }, [_vm._v("")])]), (item.checked) ? _c('div', {
      ...
      staticClass: ["panel-text"]
    }, [_vm._v("请求交货日期：" + _vm._s(item.frmPkupDtt))]), _c('text', {
      staticClass: ["panel-text"]
    }, [_vm._v("来源地：" + _vm._s(item.FrmShpgLocName))]), _c('text', {
      staticClass: ["panel-text"]
    }, [_vm._v("目的地：" + _vm._s(item.ToShpgLocName))]), _c('div', {
      staticClass: ["panelBottom"]
    }, [_c('text', {
      staticClass: ["panel-text", "pOne"]
    }, [_vm._v("箱数：" + _vm._s(item.totPce))]), _c('text', {
      staticClass: ["panel-text", "pOne"]
    }, [_vm._v("托数：" + _vm._s(item.totSkid))]), _c('text', {
      staticClass: ["panel-text", "pOne"]
    }, [_vm._v("百升数：" + _vm._s(item.Volum_HL))]), _c('text', {
      staticClass: ["panel-text", "pOne"]
    }, [_vm._v("重量：" + _vm._s(item.Weight))])])]) : _vm._e()])
  })], 2)]), (_vm.lists.ListD.length > 0) ? _c('div', {
    staticClass: ["sku-title"]
  }, [_c('text', {
    staticClass: ["font30"]
  }, [_vm._v("SKU")])]) : _vm._e(), _vm._l((_vm.lists.ListD), function(item) {
    return _c('div', {
      key: item,
      staticClass: ["sku-body"]
    }, [_c('text', {
      staticClass: ["sku-text"]
    }, [_vm._v("交货单号：" + _vm._s(item.ShipmentId))]), _c('div', {
      staticStyle: {
        flexDirection: "row"
      }
    }, [_c('text', {
      staticClass: ["sku-text", "sku-abs"]
    }, [_vm._v("物料编码：" + _vm._s(item.SKUID))]), _c('text', {
      staticClass: ["sku-text", "sku-abs"]
    }, [_vm._v("箱数：" + _vm._s(item.totPce))])]), _c('text', {
      staticClass: ["sku-text"]
    }, [_vm._v(_vm._s(item.SKUName))]), _c('div', {
      staticStyle: {
        flexDirection: "row"
      }
    }, [_c('text', {
      staticClass: ["sku-text", "sku-abs"]
    }, [_vm._v("重量：" + _vm._s(item.Weight))]), _c('text', {
      staticClass: ["sku-text", "sku-abs"]
    }, [_vm._v("百升数：" + _vm._s(item.Volum_HL))])])])
  }), _c('div', {
    staticClass: ["secondcontainer"]
  }, [_c('wxc-cell', {
    ...
    staticClass: ["cell-placeholder-first"],
    attrs: {
      "slot": "value"
    },
    slot: "value"
  }, [_vm._v(_vm._s(_vm.listFirstItem.statusName))])]), _c('wxc-cell', {
    staticClass: ["cellstyle"],
    attrs: {
      "title": "司机",
      "hasArrow": true,
    ...
    on: {
      "wxcCellClicked": _vm.driverCellClicked
    }
  }, [(_vm.selectedDriver.text) ? _c('text', {
    staticClass: ["cell-placeholder-second"],
    attrs: {
      "slot": "value"
    },
    slot: "value"
  }, [_vm._v(_vm._s(_vm.selectedDriver.text))]) : _c('text', {
    staticClass: ["cell-placeholder-second"],
    attrs: {
      "slot": "value"
    },
    slot: "value"
  }, [_vm._v(_vm._s(_vm.listFirstItem.DriverName))])]), _c('wxc-cell', {
    staticClass: ["cellstyle"],
    attrs: {
      "title": "车辆信息",
      "hasArrow": true,
    ...
    on: {
      "wxcCellClicked": _vm.truckCellClicked
    }
  }, [(_vm.selectedTruck.text) ? _c('text', {
    staticClass: ["cell-placeholder-third"],
    attrs: {
      "slot": "value"
    },
    slot: "value"
  }, [_vm._v(_vm._s(_vm.selectedTruck.text))]) : _c('text', {
    staticClass: ["cell-placeholder-third"],
    attrs: {
      "slot": "value"
    },
    slot: "value"
  }, [_vm._v(_vm._s(_vm.listFirstItem.TruckNo))])]), _c('wxc-cell', {
    staticClass: ["cellstyle"],
    attrs: {
      "title": "挂车信息",
      "hasArrow": true,
    ...
    on: {
      "wxcCellClicked": _vm.gcTruckCellClicked
    }
  }, [(_vm.selectedgcTruck.text) ? _c('text', {
    staticClass: ["cell-placeholder-third"],
    attrs: {
      "slot": "value"
    },
    slot: "value"
  }, [_vm._v(_vm._s(_vm.selectedgcTruck.text))]) : _c('text', {
    staticClass: ["cell-placeholder-third"],
    attrs: {
      "slot": "value"
    },
    slot: "value"
  }, [_vm._v(_vm._s(_vm.listFirstItem.GTruckNo))])])], 1), (_vm.isChangeInfo) ? _c('text', {
    staticClass: ["changeDriver-text", "changeDriver-text-highted"],
    on: {
      "click": _vm.wxChangeDriverClick
    }
  }, [_vm._v("更换司机/车辆")]) : _c('text', {
    staticClass: ["changeDriver-text"],
    on: {
      "click": _vm.wxChangeDriverClick
    }
  }, [_vm._v("更换司机/车辆")]), _c('text', {
    staticClass: ["changeDriver-text"],
    on: {
      "click": _vm.cancelAssign
    }
  }, [_vm._v("取消指派")]), (_vm.lists.ListA.length == 0) ? _c('text', {
    staticStyle: {
      marginTop: "50px",
      textAlign: "center"
    }
  }, [_vm._v("没有数据")]) : _vm._e()], 2), _c('wxc-dialog', {
    attrs: {
      "title": "温馨提示",
      "show": _vm.Escshow,
      "single": false,
  ...
  }, [_vm._v("确定取消指派？")])])])]), _c('wxc-dialog', {
    attrs: {
      "title": "温馨提示",
      "show": _vm.changeEscshow,
      "single": false,
      "isChecked": _vm.isCheckedDL,
      "showNoPrompt": false
    },
    on: {
      "wxcDialogCancelBtnClicked": _vm.changeTruckDialogCancelBtnClicked,
      "wxcDialogConfirmBtnClicked": _vm.changeTruckDialogConfirmBtnClick,
      "wxcDialogNoPromptClicked": _vm.kwxcDialogNoPromptClicked
    }
  }, [_c('div', {
    staticClass: ["dialog-content"],
