...
__vue_options__.__file = "/Users/mac/Documents/DTS/dtsweex1/src/truckmanager/TMTruckSelect.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-89ffce7a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        ...
        selectItem: function selectItem(item) {
            storage.setItem(_TMTruckConstants.tm_truck_selected, JSON.stringify(item), function (event) {});
        ...
        contentRefresh: function contentRefresh() {
            ...
            // modal.toast({message:`${app_server_url}/TruckAssign/GetBillSelectTruck?UserID=${this.UserId}&sOrg_id=${this.sOrg_id}&sTruckText=${sTruckText}`});
            stream.fetch({
                method: "GET",
                url: app_server_url + "/TruckAssign/GetBillSelectTruck?UserID=" + this.UserId + "&sOrg_id=" + this.sOrg_id + "&sTruckText=" + sTruckText,
                type: "json"
            }, function (ret) {
                ...
                if (ret.ok === false) {
                    ...
                    _this.lists = ret.data.Data.SelectTruck;
                }
            });
        }
    },
